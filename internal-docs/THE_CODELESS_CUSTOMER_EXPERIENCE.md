...
Engi enables customers to accomplish complex software engineering tasks through natural language alone—no code required. **Executions** are the core mechanism: intelligent, multi-agent pipeline runs that transform requirements into production-ready code artifacts.
...
Engi produces four distinct deliverable types, each serving a different stage of the software development lifecycle. Customers choose the deliverable type through natural language—the system comprehends intent and selects the appropriate pipeline.
...
const uploadAvatar = async (file: File, userId: string) => {
  ...
  await s3.putObject({ Bucket: 'engi-avatars', Key: key, Body: file });
  return `https://cdn.engi.com/${key}`;
};
...
**Technical Implementation**: `/Users/g/Developer/engi/engi/supabase/migrations/002_instructions_table.sql:4`
...
**Technical Implementation**: `/Users/g/Developer/engi/engi/packages/pipelines/deliverable/src/agents/validation/deliverable-pipeline-ready-to-instruct-agent.ts:1`
...
**Technical Implementation**: `/Users/g/Developer/engi/engi/packages/pipelines-generics/src/executors/wait-for-instruction.ts:64`
...
**Calculation**: `/Users/g/Developer/engi/engi/packages/pipelines/deliverable/src/agents/validation/deliverable-pipeline-ready-to-instruct-agent.ts:39`
...
**UI Mapping**: `/Users/g/Developer/engi/engi/uapi/components/base/engi/execution/InstructionConfidenceTimer.tsx:49`
...
**Duration Calculation**: `/Users/g/Developer/engi/engi/packages/pipelines-generics/src/executors/wait-for-instruction.ts:19`
...
**UI Implementation**: `/Users/g/Developer/engi/engi/uapi/components/base/engi/execution/InstructionConfidenceTimer.tsx:70`
...
**Technical Implementation**: `/Users/g/Developer/engi/engi/packages/pipelines-generics/src/executors/wait-for-instruction.ts:20`
...
**File Reference**: `/Users/g/Developer/engi/engi/internal-docs/EXECUTIONS.md:399`
...
**File Reference**: `/Users/g/Developer/engi/engi/packages/pipelines-generics/src/executors/wait-for-instruction.ts:36`
