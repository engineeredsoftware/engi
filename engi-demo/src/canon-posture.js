...
export const ACTIVE_CANON_VERSION = 'V23';
export const DRAFT_TARGET_VERSION = 'V24';
...
export function buildCanonPosture() {
  return {
    ...
    heroLede: `Active canon is ${ACTIVE_CANON_VERSION}: full-system current canon, generated-only proof appendix discipline, exact proof-family inventories, and executable promotion truth. ${DRAFT_TARGET_VERSION} is the current system draft target, and runtime, API, browser shell, tests, and demo-local docs must stay aligned to this posture source so canon drift fails closed.`,
    heroTip: `Hover or focus the info badges beside core ENGI terms to get plain-language explainers. The active generated appendix target is ${ACTIVE_PROVEN_APPENDIX_PATH}; current posture checks fail closed when runtime, API, browser shell, tests, or demo-local docs drift from the pointed canon.`
  };
}
