...
function main() {
  ...
  assertCheck(failures, roadmap.includes('Current working gate: V41 Gate 4'), 'Roadmap must name V41 Gate 4 as current working gate.');
  assertCheck(failures, roadmap.includes('Next queued gate after V41 Gate 4: V41 ReadNeedComprehensionSynthesis Prompt Rewrite And Return-Type Hardening.'), 'Roadmap must name V41 Gate 5 as next.');
