...
# Regenerate exports for all PromptParts under specific/ (excluding index.ts)
# Non-destructive: only rewrites index.ts in the target folder.

ROOT_DIR=$(cd "$(dirname "$0")/.." && pwd)
TARGET_DIR="$ROOT_DIR/packages/prompts/src/raw_promptparts/specific"
...

{
  ...
  echo "// Regenerated by scripts/regenerate-prompts-specific-index.sh"
