...
const coverageRows = Object.freeze([
  ...
  },
  {
    ...
    fixture: 'packages/btd/__tests__/btc-fee-operation.test.ts; packages/btd/__tests__/btd.test.ts; packages/btd/__tests__/v32-ledger-btd-settlement-failure-states.test.ts; packages/protocol/test/protocol-package-boundary.test.js',
    replayCommand: 'pnpm --filter @bitcode/btd test -- --runTestsByPath __tests__/btc-fee-operation.test.ts __tests__/btd.test.ts __tests__/v32-ledger-btd-settlement-failure-states.test.ts && pnpm run check:v32-ledger-btd-settlement-failure-states && pnpm --filter @bitcode/protocol test',
  ...
  },
  {
    ...
    fixture: 'uapi/tests/api/readReviewRoute.test.ts; uapi/tests/api/pipelineHarnessRoute.test.ts; uapi/tests/api/vcsRoutes.test.ts; uapi/tests/userDataRoute.test.ts; packages/api/src/routes/__tests__/btd-crypto.test.ts; uapi/tests/api/conversationsRouteRead.test.ts',
    replayCommand: 'pnpm --dir uapi exec jest --runTestsByPath tests/api/readReviewRoute.test.ts tests/api/pipelineHarnessRoute.test.ts tests/api/vcsRoutes.test.ts tests/userDataRoute.test.ts tests/api/conversationsRouteRead.test.ts --runInBand && pnpm --filter @bitcode/api exec jest --config jest.config.cjs --runTestsByPath src/routes/__tests__/btd-crypto.test.ts --runInBand && pnpm run check:v32-interface-contract-regression-suites',
    expectedArtifact: '.bitcode/v32-interface-contract-regression-suite.json',
    sourceSafetyClass: 'source-safe-internal',
    coverageStatus: 'v32-expansion-required',
    plannedGate: 'Gate 6',
  ...
  },
  {
    ...
    fixture: 'uapi/tests/terminalJournalReconciliation.test.ts; packages/pipeline-hosts/src/__tests__/asset-pack-harness.test.ts; packages/btd/__tests__/btc-fee-operation.test.ts; packages/btd/__tests__/v32-ledger-btd-settlement-failure-states.test.ts',
    replayCommand: 'pnpm --dir uapi exec jest --runTestsByPath tests/terminalJournalReconciliation.test.ts --runInBand && pnpm --filter @bitcode/pipeline-hosts exec jest --config jest.config.cjs --runTestsByPath src/__tests__/asset-pack-harness.test.ts --runInBand && pnpm --filter @bitcode/btd test -- --runTestsByPath __tests__/btc-fee-operation.test.ts __tests__/v32-ledger-btd-settlement-failure-states.test.ts && pnpm run check:v32-ledger-btd-settlement-failure-states',
    expectedArtifact: '.bitcode/v32-ledger-btd-settlement-failure-state-coverage.json',
    sourceSafetyClass: 'source-safe-generated-proof',
    coverageStatus: 'v32-expansion-required',
    plannedGate: 'Gate 5',
  ...
  },
  {
    ...
    fixture: 'packages/pipeline-hosts/src/__tests__/asset-pack-harness.test.ts; packages/btd/__tests__/v32-ledger-btd-settlement-failure-states.test.ts; protocol-demonstration/test/core.test.js',
