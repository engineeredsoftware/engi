...
| V31 | `BITCODE_SPEC_V31_NOTES.md` | future notes | Deeper Auxillaries after Protocol/BTD rails stabilize: profile, connects, interfaces, BTD panes, provider readiness, account state, team/org/wallet/multi-sig/role/policy controls, readiness diagnostics, recovery flows, responsive/accessibility QA, and Auxillaries-specific tests/proofs. |
