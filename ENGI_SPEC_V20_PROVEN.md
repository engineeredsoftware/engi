...
| --- | --- | --- |
| `.engi/v19-contract-change-ledger.json` | `sha256:a684eb6a19a5edde986285e24c05668e578d3ba8dcc96830ab6dda7b93cba303` | 3290 |
| `.engi/v19-deterministic-replay-report.json` | `sha256:58418489854bdb359221837fd8ed305b78b02a6f07d90b4dd0792b463d5204d7` | 8426 |
| `.engi/v19-negative-proof-mutation-matrix.json` | `sha256:540b07b19143d3f565ce71ac9541b938cd754672380a0fb11452eb43b8dcc4c3` | 8049 |
| `.engi/v19-proof-member-semantic-matrix.json` | `sha256:4e4f62ea346e652fb56359b797c515274f11819398f8be8c3abbd21e7fe77434` | 1682034 |
| `.engi/v19-state-machine-matrix.json` | `sha256:729679a10f78fa859accf0131b253c451cfdab2344e006c430466094c2debafc` | 154149 |
| `.engi/v19-theorem-evidence-matrix.json` | `sha256:1037bf70baa870b0f0a68580d44cf429256e0c3bec81fbd6867b04ceb4b2cc56` | 2246792 |
| `.engi/v19-volatility-inventory.json` | `sha256:b0f2fc918462c4b7db333c8f48c787a276fd4cff5a1e7a9a796fde81a13791d0` | 6197 |
...
| --- | --- | --- | --- |
| `.engi/v19-contract-change-ledger.json` | `sha256:a684eb6a19a5edde986285e24c05668e578d3ba8dcc96830ab6dda7b93cba303` | `sha256:a684eb6a19a5edde986285e24c05668e578d3ba8dcc96830ab6dda7b93cba303` | `true` |
| `.engi/v19-negative-proof-mutation-matrix.json` | `sha256:540b07b19143d3f565ce71ac9541b938cd754672380a0fb11452eb43b8dcc4c3` | `sha256:540b07b19143d3f565ce71ac9541b938cd754672380a0fb11452eb43b8dcc4c3` | `true` |
| `.engi/v19-proof-member-semantic-matrix.json` | `sha256:4e4f62ea346e652fb56359b797c515274f11819398f8be8c3abbd21e7fe77434` | `sha256:4e4f62ea346e652fb56359b797c515274f11819398f8be8c3abbd21e7fe77434` | `true` |
| `.engi/v19-state-machine-matrix.json` | `sha256:729679a10f78fa859accf0131b253c451cfdab2344e006c430466094c2debafc` | `sha256:729679a10f78fa859accf0131b253c451cfdab2344e006c430466094c2debafc` | `true` |
| `.engi/v19-theorem-evidence-matrix.json` | `sha256:1037bf70baa870b0f0a68580d44cf429256e0c3bec81fbd6867b04ceb4b2cc56` | `sha256:1037bf70baa870b0f0a68580d44cf429256e0c3bec81fbd6867b04ceb4b2cc56` | `true` |
| `.engi/v19-volatility-inventory.json` | `sha256:b0f2fc918462c4b7db333c8f48c787a276fd4cff5a1e7a9a796fde81a13791d0` | `sha256:b0f2fc918462c4b7db333c8f48c787a276fd4cff5a1e7a9a796fde81a13791d0` | `true` |
| `ENGI_SPEC_V19_PROVEN.md` | `sha256:095fec3002c4233bc5d8662804adf1a70a8e0be2aa38527d2f0c17f48fe851ab` | `sha256:095fec3002c4233bc5d8662804adf1a70a8e0be2aa38527d2f0c17f48fe851ab` | `true` |
...
| artifactPath | digest | byteLength |
| --- | --- | --- |
| `.engi/v20-accessibility-report.json` | `sha256:a1486534058179e95a6e6f038ed555ad740eb01796528d20ce649b9155a06423` | 8202 |
| `.engi/v20-operator-acceptance-transcript.json` | `sha256:b1993970574a5897eae7a8942baca8d99caa86ad273f0126246b02b15384c94f` | 10837 |
| `.engi/v20-performance-budget-report.json` | `sha256:1d3b58da395262d2053254c481357f1c3e5d72654358f913867967612385b32e` | 5030 |
| `.engi/v20-projection-quality-smoke-matrix.json` | `sha256:3388f412fab4abe845741e4757918fb4d899ccfc579b462c4b6318e22b52053a` | 4927 |
| `.engi/v20-quality-summary.json` | `sha256:5cb43495b6b83054cd2fb716735b08fd3fafe01850583c56176b5ec247aaa058` | 4397 |
| `.engi/v20-visual-regression-report.json` | `sha256:195686fe648d5c2c9c911b8e5e8712a5387fbb3b9033b93ef16be90a2ec09d8d` | 19353 |
