# ENGI Spec V21 Proven

- canonicalVersion: `V21`
- canonicalCommit: `33f3a75734fd6c0213c95b48f2e373c72fb1b735`
- canonicalCommitRecordedAt: `2026-04-12T11:23:06-03:00`
- worktreeState: `clean`
- generatorId: `engi-demo.proven-generator.v1`
- generatedAt: `2026-04-12T11:23:06-03:00`
- outputPath: `ENGI_SPEC_V21_PROVEN.md`
...
- v21SpecFamilyPassed: `false`
- v21CanonicalInputsPassed: `false`
- v21GeneratedArtifactCount: `2`
...
| --- | --- | --- |
| `.engi/v19-contract-change-ledger.json` | `sha256:f2821881df8a00a582359b3c09700dc0fc89412a2db37ec0e8aaec40dadd9c2d` | 3290 |
| `.engi/v19-deterministic-replay-report.json` | `sha256:27fc9cef0055e1a689b56ce2f4359a66f11e6aab3afd513318e4b29aed20bda2` | 8426 |
| `.engi/v19-negative-proof-mutation-matrix.json` | `sha256:baca5bd8bdc3f72ac440758e66544e760e033ffc4e7b510fbd2ab8b46966b334` | 8049 |
| `.engi/v19-proof-member-semantic-matrix.json` | `sha256:67efffd2d72e64efbf966c223ca924a029e1653b27ac5c5dcff06b0b06f94f81` | 1682034 |
| `.engi/v19-state-machine-matrix.json` | `sha256:2960ebc0c66c9ee4e766612edc3d82733d223550657ecfdf635302e194565699` | 154149 |
| `.engi/v19-theorem-evidence-matrix.json` | `sha256:3aff33b93e65251399ca77b4bdd86bf6579b210266269e9d6a631e3f5f03afe2` | 2246792 |
| `.engi/v19-volatility-inventory.json` | `sha256:4db0febdefb8a2c569cfafb7e85e1c3a231cb84cb187be81d3fda4e0842220d7` | 6197 |
...
| --- | --- | --- | --- |
| `.engi/v19-contract-change-ledger.json` | `sha256:f2821881df8a00a582359b3c09700dc0fc89412a2db37ec0e8aaec40dadd9c2d` | `sha256:f2821881df8a00a582359b3c09700dc0fc89412a2db37ec0e8aaec40dadd9c2d` | `true` |
| `.engi/v19-negative-proof-mutation-matrix.json` | `sha256:baca5bd8bdc3f72ac440758e66544e760e033ffc4e7b510fbd2ab8b46966b334` | `sha256:baca5bd8bdc3f72ac440758e66544e760e033ffc4e7b510fbd2ab8b46966b334` | `true` |
| `.engi/v19-proof-member-semantic-matrix.json` | `sha256:67efffd2d72e64efbf966c223ca924a029e1653b27ac5c5dcff06b0b06f94f81` | `sha256:67efffd2d72e64efbf966c223ca924a029e1653b27ac5c5dcff06b0b06f94f81` | `true` |
| `.engi/v19-state-machine-matrix.json` | `sha256:2960ebc0c66c9ee4e766612edc3d82733d223550657ecfdf635302e194565699` | `sha256:2960ebc0c66c9ee4e766612edc3d82733d223550657ecfdf635302e194565699` | `true` |
| `.engi/v19-theorem-evidence-matrix.json` | `sha256:3aff33b93e65251399ca77b4bdd86bf6579b210266269e9d6a631e3f5f03afe2` | `sha256:3aff33b93e65251399ca77b4bdd86bf6579b210266269e9d6a631e3f5f03afe2` | `true` |
| `.engi/v19-volatility-inventory.json` | `sha256:4db0febdefb8a2c569cfafb7e85e1c3a231cb84cb187be81d3fda4e0842220d7` | `sha256:4db0febdefb8a2c569cfafb7e85e1c3a231cb84cb187be81d3fda4e0842220d7` | `true` |
| `ENGI_SPEC_V19_PROVEN.md` | `sha256:34e7169462680c739cee0b313c1f518b6c07b9c05c4991491d42cb040686360d` | `sha256:34e7169462680c739cee0b313c1f518b6c07b9c05c4991491d42cb040686360d` | `true` |
...
| artifactPath | digest | byteLength |
| --- | --- | --- |
| `.engi/v20-accessibility-report.json` | `sha256:d1001772bd6614ad9dea32d026ade0098e9aafe0c4c6943771d4fb5628be61dc` | 8202 |
| `.engi/v20-operator-acceptance-transcript.json` | `sha256:3b5203c1bbd7f8aa1c5c745851935e6c934bf498f0a56d685f0e87440bb0fe5b` | 10837 |
| `.engi/v20-performance-budget-report.json` | `sha256:c4a8967b31bd835f706539b8d36c544ea4635cb1a01e17f47539ab6a34881144` | 5030 |
| `.engi/v20-projection-quality-smoke-matrix.json` | `sha256:c2f2d55832cd0a8964a2f0d5a3ce447100d41232769dc9c2d59e1bf9989a2e57` | 4927 |
| `.engi/v20-quality-summary.json` | `sha256:7b423be8d23375e8942e42003a1f59419d8ee091c8e53473cb767f827ad8f425` | 4397 |
| `.engi/v20-visual-regression-report.json` | `sha256:a4f40584d5fdac32f21f2328a060c8aba03e9fbdc4248e4d181fcba0c7861211` | 19353 |
...
### V21 Generated Specifying Artifact Inventory

| artifactPath | digest | byteLength |
| --- | --- | --- |
| `.engi/v21-canonical-input-report.json` | `sha256:b79343791294c409dc38667c9b53f8fb7f9016b8c05636071c88b993c692aece` | 929 |
| `.engi/v21-spec-family-report.json` | `sha256:a75f2455c668ceabc01fba374422421e0192252cf8f11bdae399be993dfadb2a` | 1219 |

### V21 Spec-Family Report
...
| --- | --- |
| `ENGI_SPEC_V21.md` | `ENGI_SPECIFYING.md` |
| `ENGI_SPEC_V21_DELTA.md` | `ENGI_SPEC_TEMPLATEGUIDE.md` |
| `ENGI_SPEC_V21_PARITY_MATRIX.md` | `none` |

### V21 Canonical-Input Report
...
| --- | --- | --- |
| `ENGI_SPEC_V20.md` | `ENGI_SPEC_V20_PROVEN.md` | `.engi/v20-operator-acceptance-transcript.json`, `.engi/v20-visual-regression-report.json`, `.engi/v20-accessibility-report.json`, `.engi/v20-performance-budget-report.json`, `.engi/v20-projection-quality-smoke-matrix.json`, `.engi/v20-quality-summary.json` |
...
| `.engi/authorization-decisions.json` | `sha256:2e362db36bb9623d05774afb6675d130a242038ba63946d36ab1630dc395a697` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow.json` | `sha256:81a8233a50c94aa39162863316f73eb89ad95b4451c9ce200b98147f9715e47c` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/authorization-decisions.json` | `sha256:139bf2c6dd4c273de880f6210f6a0030c1fa3e2d83f65d30f5b317a5190bd8b8` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow-proof.json` | `sha256:bbeaf4904429e16a85c4d47808299e9c49713fa8cbb987b14c39ca79295bc192` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
| `.engi/sensitive-data-flow.json` | `sha256:f69f7fc9a79880a14387ef64bb0a7f60feaddbe1c7faaf74c0ef0659ef3d9bb8` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/authorization-decisions.json` | `sha256:d749074d5dca9222cdbc1eb974d25f8af6c8a89a7799984b61dbc09f52847b44` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow.json` | `sha256:d04d08685e53160ced92711c6f820c710d0e0bb86d8ca95e6f5ce10d5cfd6647` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/authorization-decisions.json` | `sha256:005bbf6925afbfac15dc318071e2f539a321979b209d35b4ee5038b23407ceba` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow.json` | `sha256:f666fa9cb83a566d100962cdd40b6cef292021df01a94da2ebf307f23ead23c7` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/authorization-decisions.json` | `sha256:cf119d4b74c367a59132bf51d68257fdfac03930466927ebe5492831a15dbf46` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow.json` | `sha256:a9a85ce754bf81fc491455a200ed71a4daa6b86eeeb152ce6e78ce38a5827220` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/authorization-decisions.json` | `sha256:0fec793384c0b6da505f2828cd1cf7a180b40b1d012de0272060f9c07e1fc39d` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow.json` | `sha256:3e22a18921160139b219267e06fee93c15ecc297671c8122af2ea6374c39e7b1` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/authorization-decisions.json` | `sha256:22d6df3ab6e73b2ad2f30b909963d10e9b43dc4d7a796c2ae01a07930a7c843e` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow.json` | `sha256:e3a2710f59f8dd95985aefc6e57ea82da9070dc2e0ef9a7705a7619eb141efc7` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/authorization-decisions.json` | `sha256:ab5044293d26d223061f376e83f47523a81e6f569a20a6b0a1b2b708f36d14bd` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow.json` | `sha256:c964fa66f7e5a6873b125d62716bdfde6111164c6544ea6fba84eeb9be965a1d` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/authorization-decisions.json` | `sha256:8b962d19640f2e8f4b8b68f86893ae8950b738ef1f4d952d8922e52d72594059` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
...
| `.engi/sensitive-data-flow.json` | `sha256:e48485693a95ebf418dcda4ec4a94b075818f1294c733d18258c691704446d30` | `authorization-and-sensitive-flow` | `private-proof-artifact` | `false` |
