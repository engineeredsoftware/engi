...
- **F26-A (pending)**: remove `runtime-inference-policy` profile fns + `bounded-structured-inference`; de-gate the ~7 read-lens agents to always-PTRR; build boundary LLM-mock test infra (none exists) and rework the read-agent tests.
