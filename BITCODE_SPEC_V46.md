...
- Generated structured artifact inventory: draft `.bitcode/v46-spec-family-report.json` and `.bitcode/v46-canonical-input-report.json`; later V46 gates must add proof, rehearsal, workflow, and promotion artifacts only after their scope is accepted
...
Validation commands include `check:v46-gate1`, draft V46 spec-family checks,
active V45 promoted checks, V45/V46 canon posture drift checks, and later
parity, proof, implementation, rehearsal, and promotion commands.
