...
The minimum V32 generated set is `.bitcode/v32-spec-family-report.json`, `.bitcode/v32-canonical-input-report.json`, `.bitcode/v32-canon-posture-drift-report.json`, `.bitcode/v32-proof-coverage-matrix.json`, `.bitcode/v32-reading-pipeline-proof-coverage.json`, and promotion-time `BITCODE_SPEC_V32_PROVEN.md`.
