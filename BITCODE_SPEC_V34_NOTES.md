...
- Scope: future notes for deeper Deployment after V28 MVP QA, V29 Terminal depth, V30 Exchange depth, V31 Auxillaries depth, V32 provation/testing depth, and V33 Interfaces.
...
V28 owns commercial app MVP QA.
...
- runtime expectations for wallet, BTC fee, ledger observation, Exchange settlement, Terminal journals, reconciliation, and repair jobs;
