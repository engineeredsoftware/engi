...
| retained execution composer and template path | Shippable template selection plus AssetPack execution submission | active component, hook, style, streaming, and route-log names move to Shippable/AssetPack while retained database tables and `/api/deliverables` mount remain compatibility storage/interface boundaries |
