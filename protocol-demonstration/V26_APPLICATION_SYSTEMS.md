...
- retained raw promptparts and promptpart-generation scripts in this corridor should likewise stay compatible by identifier while their actual prompt text and generation guidance describe asset-pack-run, need-satisfaction, written-asset, and shipping-wrapper semantics; deeper phase-purpose, setup-comprehension, shipping-finalization, deliverables-system, implementation-divider, create-code-change, PR-packaging, and create-pull-request promptparts should therefore teach Bitcode-first execution meaning instead of PR-first / GA-1 residue
