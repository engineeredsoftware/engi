...
resolves to `V41`; V42 is the next draft target after this promotion. This demo is governed by the active V42 canonical
spec and `BITCODE_SPEC_V42_PROVEN.md` as the current generated appendix.
