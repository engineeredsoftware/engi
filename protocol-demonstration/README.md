# Bitcode Protocol Demonstration - V44 canonical deterministic local prototype
...
resolves to `V43`; V44 is the next draft target after this promotion. This demo is governed by the active V44 canonical
spec and `BITCODE_SPEC_V44_PROVEN.md` as the current generated appendix.
`BITCODE_SPEC.txt -> V44`.
