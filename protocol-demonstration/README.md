# Bitcode Protocol Demonstration - V46 canonical deterministic local prototype
...
resolves to `V43`; V44 is the next draft target after this promotion. This demo is governed by the active V46 canonical
spec and `BITCODE_SPEC_V46_PROVEN.md` as the current generated appendix.
`BITCODE_SPEC.txt -> V46`.
