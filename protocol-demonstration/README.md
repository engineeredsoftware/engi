# Bitcode Protocol Demonstration - V45 canonical deterministic local prototype
...
resolves to `V43`; V44 is the next draft target after this promotion. This demo is governed by the active V45 canonical
spec and `BITCODE_SPEC_V45_PROVEN.md` as the current generated appendix.
