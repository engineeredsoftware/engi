...
resolves to `V37`; V38 is the active draft target after this promotion. This demo is governed by the active V37 canonical
spec and `BITCODE_SPEC_V37_PROVEN.md` as the current generated appendix while
V38 opens inference stack and fit-finding specification work.
