...
## What this protocol owner carries
...
The primary review surface is no longer the standalone protocol runtime.
The primary review surface is:
- `/application`

`protocol-demonstration` remains essential because `/application` still mounts and reads:
...
Run the protocol-local validation runtime:
