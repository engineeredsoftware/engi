...
| Demo-local artifact coverage | `.engi/*` artifact families are built and tested from `src/bitcode-demo.js` | demo spec must describe the artifact families it emits | closed |
