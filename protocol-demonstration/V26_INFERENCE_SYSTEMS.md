...
| `packages/generic-agents/web-researcher/*`, `packages/generic-tools/web-search/*`, `packages/web-search/*` | retained external search corridor now specified as admitted discovery-phase need-synthesis web research for source-attributed need context, third-party interface planning, proof-gap question formation, and AssetPack planning |
...
- retained need-synthesis web research compatibility prompts
