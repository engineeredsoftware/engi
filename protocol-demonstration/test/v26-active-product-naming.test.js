...
const deliverableCreatePullRequestAgentSource = readFileSync(new URL('../../packages/pipelines/asset-pack/src/agents/finish-compatibility/deliverable-pipeline-create-pull-request-agent.ts', import.meta.url), 'utf8');
