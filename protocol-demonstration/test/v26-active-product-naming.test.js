...
const updateDeliverableTableNamesScriptSource = readFileSync(new URL('../../scripts/update-deliverable-table-names.sh', import.meta.url), 'utf8');
const updateDeliverableAgentsScriptSource = readFileSync(new URL('../../scripts/update-deliverable-agents.sh', import.meta.url), 'utf8');
const promptAuditScriptSource = readFileSync(new URL('../../scripts/prompt-audit.sh', import.meta.url), 'utf8');
const generateDeliverablePromptPartsTsSource = readFileSync(new URL('../../scripts/generate-deliverable-promptparts.ts', import.meta.url), 'utf8');
...
test('active V26 retained package surfaces use Bitcode naming instead of Engi naming', () => {
  ...
  assert.match(updateDeliverableTableNamesScriptSource, /repo_root="\$\(cd "\$\(dirname "\$\{BASH_SOURCE\[0\]\}"\)\/\.\."/);
  ...
  assert.match(generateDeliverablePromptPartsTsSource, /Comprehend Need/);
  assert.match(generateDeliverablePromptPartsTsSource, /asset-pack run semantics/);
  ...
  assert.doesNotMatch(updateDeliverableTableNamesScriptSource, /Developer\/engi\/engi/);
  assert.doesNotMatch(updateDeliverableAgentsScriptSource, /Developer\/engi\/engi/);
  ...
  assert.doesNotMatch(generateDeliverablePromptPartsTsSource, /comprehendtask/);
  assert.doesNotMatch(generateDeliverablePromptPartsTsSource, /packages\/prompts\/src\/raw\/specific/);
