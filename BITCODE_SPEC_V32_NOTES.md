...
- Version: `V32`
- V32 state: future notes scaffold only
...
Requirements become binding only when V32 is explicitly opened as the draft-target SPEC family.
...
- browser, accessibility, responsive, and visual regression testing;
- testnet/mainnet-readiness proof rehearsal without silently approving value-bearing launch.

## Boundaries

V32 deepens proof and testing systems.
It should not add new product surface scope except where needed to prove existing surfaces.

## Return To V28

Do not start V32 implementation during V28.
Capture missing proof/test needs as V28 QA findings, then defer depth to V32.
