...
const env = {
  ...
  NEXT_PUBLIC_DISABLE_TERMINAL_LINK: process.env.NEXT_PUBLIC_DISABLE_TERMINAL_LINK,
  NEXT_PUBLIC_TERMINAL_DEBUG_WIDGET: process.env.NEXT_PUBLIC_TERMINAL_DEBUG_WIDGET,
