...
exports.MOCK_USER_ORBITAL = process.env.NEXT_PUBLIC_MOCK_USER_ORBITAL === 'true';
exports.MOCK_USER_ORBITAL_SCENARIO = process.env.NEXT_PUBLIC_MOCK_USER_ORBITAL_SCENARIO || 'default';
