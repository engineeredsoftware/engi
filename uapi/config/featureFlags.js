...
exports.MASTER_MOCK_MODE = process.env.NEXT_PUBLIC_MASTER_MOCK_MODE === 'true';
exports.ENABLE_MOCKS = exports.MASTER_MOCK_MODE || process.env.NEXT_PUBLIC_ENABLE_MOCKS === 'true';
exports.MOCK_MEASURE = process.env.NEXT_PUBLIC_MOCK_MEASURE === 'true';
exports.MOCK_USER_AUXILLARIES =
    exports.ENABLE_MOCKS && (exports.MASTER_MOCK_MODE || process.env.NEXT_PUBLIC_MOCK_USER_AUXILLARIES === 'true');
