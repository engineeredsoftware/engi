...
import ApplicationFlowGuideCard from '@/app/application/ApplicationFlowGuideCard';
import type { ApplicationCommandState } from '@/app/application/application-command-state';

const baseCommandState: ApplicationCommandState = {
  scenario: 'need-1',
  projection: 'reviewer',
  branchMode: 'patch',
...
describe('ApplicationFlowGuideCard', () => {
