import { normalizeApplicationClosureControlState } from '@/app/application/application-closure-controls';

describe('normalizeApplicationClosureControlState', () => {
  it('builds closure operation posture from command and closure state', () => {
    const state = normalizeApplicationClosureControlState(
      {
  ...
  it('falls back safely when closure state is missing', () => {
    const state = normalizeApplicationClosureControlState(null, null);
