...
interface NeedDefinitionInputProps {
  /** Core functionality */
  value: string;
...
export const NeedDefinitionInput = ({
  value,
  onChange,
  onEnhance,
  repositoryContext,
  ...
  return (
    <div
      ref={containerRef}
      className={`need-definition-input relative ${className}`}
      style={{
        '--mouse-x': `${mousePos.x}%`,
        '--mouse-y': `${mousePos.y}%`,
...
export default NeedDefinitionInput;
