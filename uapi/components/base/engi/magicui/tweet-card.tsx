  ...
  <div className="flex flex-1 items-center justify-center">
    ...
    {tweet.photos && (
      <div className="relative flex transform-gpu snap-x snap-mandatory gap-4 overflow-x-auto">
        <div className="shrink-0 snap-center tablet:w-2" />
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "mx-auto relative flex h-full w-full max-w-[32rem] flex-col gap-2 overflow-hidden rounded-lg border p-4 backdrop-blur-md",
        className,
      )}
      {...props}
    >
