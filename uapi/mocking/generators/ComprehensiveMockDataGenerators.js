...
class ComprehensiveMockDataGenerator {
    ...
    generateDeliverableInstructions() { return this.generateInstructionsData('deliverable'); }
    ...
    // Templates & Preferences
    generateDeliverableTemplates() { return [{ id: 'tpl_123', name: 'React Component', category: 'frontend', usage_count: 1247 }]; }
    ...
    // Triggers & API Systems
    generateTriggers() { return [{ id: 'trigger_123', event: 'deliverable.completed', action: 'send_notification', enabled: true }]; }
    ...
    // Vector & AI
    generateDeliverableVectors() { return [{ id: 'vec_123', deliverable_id: 'del_456', embedding: [0.1, 0.2, 0.3], metadata: { category: 'frontend' } }]; }
    ...
    generateUsageAnalytics() { return { api_calls: 12470, btd_used: 5678, popular_features: ['deliverables', 'chat'] }; }
