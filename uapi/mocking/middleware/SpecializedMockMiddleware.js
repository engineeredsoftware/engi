...
exports.mockAreas = exports.mockLegacy = exports.mockAdmin = exports.mockHealth = exports.mockMCP = exports.mockPayments = exports.mockMarketplace = exports.mockIntegrations = exports.mockGitLab = exports.mockGitHub = exports.mockOrganizations = exports.mockDeliverables = exports.mockChat = exports.mockConversation = exports.mockOnboarding = exports.mockUser = exports.mockAuth = void 0;
...
const ComprehensiveMockDataGenerators_1 = require("../generators/ComprehensiveMockDataGenerators");
/**
 * Base middleware factory for creating feature-specific mock middleware
 */
function createSpecializedMiddleware(config) {
    return function (originalHandler) {
        return async function mockMiddleware(request) {
            ...
            try {
                ...
                if (config.errorInjection?.enabled && Math.random() < config.errorInjection.probability) {
                    ...
                    return server_1.NextResponse.json({ error: `Mock ${errorType} error for ${config.feature}`, code: 'MOCK_ERROR' }, { status: errorType === 'timeout' ? 408 : 500 });
                }
                // Generate mock data
                const mockData = await ComprehensiveMockDataGenerators_1.comprehensiveMockGenerator.generateMockData(config.feature, scenario, 'moderate');
                ...
                const response = server_1.NextResponse.json(mockData.data);
 ...
 */
exports.mockLegacy = {
    deliverables: () => exports.mockDeliverables.main(),
 ...
 */
function createStreamingMockResponse(data, feature) {
 ...
 */
exports.mockAreas = {
    auxillaries: { auth: exports.mockAuth, user: exports.mockUser, onboarding: exports.mockOnboarding },
    orbital: { auth: exports.mockAuth, user: exports.mockUser, onboarding: exports.mockOnboarding },
    conversation: { chat: exports.mockChat, ...exports.mockConversation },
    pipelines: { deliverables: exports.mockDeliverables },
    organizations: exports.mockOrganizations,
    integrations: { github: exports.mockGitHub, gitlab: exports.mockGitLab, ...exports.mockIntegrations },
    marketplace: exports.mockMarketplace,
    payments: exports.mockPayments,
    mcp: exports.mockMCP,
    system: { health: exports.mockHealth, admin: exports.mockAdmin }
};
