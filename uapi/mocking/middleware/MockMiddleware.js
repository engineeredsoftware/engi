...
exports.createMockMiddleware = exports.mockUserData = exports.mockGitHub = exports.mockDeliverables = void 0;
 ...
 */
const mockDeliverables = (handler) => withMocking({
    feature: 'DELIVERABLES',
    streamingSupported: true,
    performanceTracking: true
}, handler);
exports.mockDeliverables = mockDeliverables;
...
async function handleStreamingRequest(config, context, scenario) {
    const engine = StreamingPipelineEngine_1.createStreamingPipelineEngine.deliverable(scenario);
