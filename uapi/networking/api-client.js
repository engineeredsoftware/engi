...
exports.callDeliverablesAPI = callDeliverablesAPI;
/**
 ...
 */
const fetchDeliverableInstructions = async (runId) => {
...
exports.fetchDeliverableInstructions = fetchDeliverableInstructions;
/**
 * Submit an on-the-fly instruction for a deliverable run
 */
const postDeliverableInstruction = async (runId, content, attachments) => {
...
exports.postDeliverableInstruction = postDeliverableInstruction;
// -----------------------------------------------------------------------------
...
const notifyDeliverableStarted = async (params) => {
    const res = await fetch('/api/notifications/deliverable-started', {
        method: 'POST', headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(params),
    });
    if (!res.ok)
        throw new Error('Notification deliverable-started failed');
};
exports.notifyDeliverableStarted = notifyDeliverableStarted;
const notifyDeliverableCompleted = async (params) => {
    const res = await fetch('/api/notifications/deliverable-completed', {
        method: 'POST', headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(params),
    });
    if (!res.ok)
        throw new Error('Notification deliverable-completed failed');
};
exports.notifyDeliverableCompleted = notifyDeliverableCompleted;
