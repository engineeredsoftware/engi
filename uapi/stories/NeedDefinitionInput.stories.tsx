...
import { NeedDefinitionInput } from '@/components/base/bitcode/inputs/need-definition-input';

const meta: Meta<typeof NeedDefinitionInput> = {
  title: 'Bitcode/Surprise & Delight/Definition of Need Input',
  component: NeedDefinitionInput,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: `
### 🧠 Enhanced Definition of Need Input
...
export const InteractivePatternBuilding: Story = {
      ...
      <div className="w-full max-w-3xl space-y-6">
        <div className="text-center space-y-2">
          <div className="text-sm text-gray-400">
            Watch pattern recognition evolve as the Definition of Need becomes more detailed
          </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive demo showing how pattern recognition builds as Definition of Need becomes more detailed',
      },
    },
  },
};
...
- Integrate with existing authentication service`);
      ...
      <div className="w-full max-w-3xl space-y-6">
        <div className="text-center">
          <div className="text-sm text-gray-400 mb-4">
            Click the enhance button to see AI-powered Definition of Need improvement
          </div>
          <button
  ...
  parameters: {
    docs: {
      description: {
        story: 'AI enhancement demo - transforms simple Definition of Need into comprehensive specification',
      },
    },
  },
};
...
// Canonical story: renamed from EnhancedNeedDefinitionInput
