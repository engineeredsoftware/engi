// moved to app/orbitals/components/profile-pane.tsx
...
export default function ProfileStep({ onSave,
  loading,
  initialTeamMembers = [],
  initialUsername = '',
  initialDisplayName = '',
            ...
            >
              ...
              <div className="onboarding-focus-note">
                ...
                <p style={{ margin: "0", fontSize: "14px", color: "rgba(255, 255, 255, 0.8)", lineHeight: "1.5" }}>
                  Once verified, invite your team, connect your projects, and customize your workspace.
                </p>
              </div>
            </motion.div>
          )}
