...
type OrbitalsWorkspaceTone = "default" | "emerald" | "sky" | "violet" | "amber";

const TONE_STYLES: Record<OrbitalsWorkspaceTone, string> = {
...
interface OrbitalsWorkspaceSectionProps {
  kicker?: string;
  title: string;
  description?: string;
  explainer?: BitcodeExplainer;
  tone?: OrbitalsWorkspaceTone;
  className?: string;
  children: React.ReactNode;
}

export default function OrbitalsWorkspaceSection({
  kicker,
  title,
  description,
  explainer,
