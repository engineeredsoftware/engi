...
export const metadata: Metadata = {
  ...
  description:
    'Bitcode /executions route for execution primitives, asset-pack pipeline runs, and measured-Need follow-through inside the broader Bitcode activity family.',
  alternates: {
