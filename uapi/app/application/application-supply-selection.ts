...
export type ApplicationSupplySelectionState = {
...
export function normalizeApplicationSupplySelection(snapshot: ShellSnapshot): ApplicationSupplySelectionState | null {
