...
type BitcodeApplicationRuntimeHostProps = {
  className?: string;
};

export default function BitcodeApplicationRuntimeHost({
  className = '',
}: BitcodeApplicationRuntimeHostProps) {
  const rootClassName = ['bitcode-first-gate-root', className].filter(Boolean).join(' ');

  return (
    <div id="bitcodeApplicationRoot" className={rootClassName} data-bitcode-runtime-host="built-embedded">
      <div className="page">
