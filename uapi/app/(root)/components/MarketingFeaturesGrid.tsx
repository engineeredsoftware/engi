...
const features = [
  ...
  },
  {
    ...
    description: 'Engi continuously evolves and improves itself, learning from each interaction to become more powerful, efficient, and capable over time.',
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Leveraging advanced techniques inspired by quantum computing for state exploration and pre-computation, enabling Engi to predict code behavior and optimize solutions.',
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Connect your repositories, assign tasks to Engi, and receive pull requests, reviews, and comments directly in your GitHub workflow, accelerating your development process.',
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Engi generates and utilizes synthetic data to train and improve its models, enabling it to understand and predict code behavior with unprecedented accuracy.',
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'By dramatically reducing the cost and time of software development while increasing quality, Engi is poised to create trillions in economic value and accelerate technological progress.',
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Engi is designed to accelerate the development of future technologies, creating a virtuous cycle of innovation that will propel humanity forward in unprecedented ways.',
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <MarketingSectionWrapper>
      <div className="text-center mb-12">
        ...
        <p className="text-sm text-gray-400 max-w-2xl mx-auto">
          Engi represents a paradigm shift in technology creation, combining advanced AI with revolutionary approaches to engineering.
        </p>
      </div>
              ...
              <div className="space-y-3">
                <div className={infoCardClass}>
                  ...
                  <p className="text-xs text-gray-400">
                    Install the Engi GitHub App, connect your repositories, and start assigning tasks to Engi with simple labels or mentions.
                  </p>
                </div>
                <div className={infoCardClass}>
                  <h4 className="text-xs font-medium mb-1 text-emerald-400 font-mono">Automated Deliverables</h4>
                  <p className="text-xs text-gray-400">
                    Receive pull requests with code changes, detailed reviews on existing PRs, and helpful comments on issues.
                  </p>
                </div>
              </div>
            )}
            ...
            {activeFeature === 'rich-context' && (
              <div className="space-y-3">
                <div className={infoCardClass}>
                  ...
                  <p className="text-xs text-gray-400">
                    Engi analyzes your entire codebase, understanding architecture, patterns, and dependencies to deliver contextually appropriate solutions.
                  </p>
                </div>
                <div className={infoCardClass}>
            ...
            {activeFeature === 'attachments' && (
              <div className="space-y-3">
                ...
                <div className={infoCardClass}>
                  ...
                  <p className="text-xs text-gray-400">
                    Share links to documentation, articles, or other resources that Engi should consider when working on your task.
                  </p>
                </div>
              </div>
            )}
            ...
            {activeFeature === 'web-research' && (
              <div className="space-y-3">
                <div className={infoCardClass}>
                  ...
                  <p className="text-xs text-gray-400">
                    Engi uses Perplexity and Exa to perform deep, contextual searches across the web, finding relevant information for your engineering tasks.
                  </p>
                </div>
                <div className={infoCardClass}>
