...
const features = [
  ...
  },
  {
    ...
    description: 'Connect your repositories, assign tasks to Bitcode, and receive pull requests, reviews, and comments directly in your GitHub workflow, accelerating your development process.',
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
