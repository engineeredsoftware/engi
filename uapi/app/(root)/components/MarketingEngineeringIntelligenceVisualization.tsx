...
export default function MarketingEngineeringIntelligenceVisualization() {
  ...
  const screenshotsByMode: Record<'headless' | 'mobile' | 'operator' | 'api', Screenshot[]> = {
    headless: [
      ...
      { id: 'headless-2', src: '/screenshots/setup-credits.png', alt: 'Setup credits panel', type: 'component', category: 'credits', revealingSoon: true },
      { id: 'headless-3', src: '/screenshots/credits-tracker-widget.png', alt: 'Credits tracker widget', type: 'component', category: 'credits', revealingSoon: true },
    ],
    mobile: [
