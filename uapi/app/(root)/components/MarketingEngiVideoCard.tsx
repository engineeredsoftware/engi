  ...
  if (hasError) {
    return (
      <div className="flex h-full w-full flex-col justify-center gap-3 rounded-3xl border border-white/10 bg-slate-900/70 p-6 text-left shadow-[0_0_35px_rgba(16,185,129,0.2)] backdrop-blur">
        ...
        <p className="text-sm text-emerald-100/80">Drop an Engi demo at <code className="text-emerald-200">public{DEMO_VIDEO_SRC}</code> to enable inline playback.</p>
      </div>
    );
  }
      ...
      {isPlaying ? (
        ...
        >
          ...
          <div className="space-y-1">
            <p className="text-lg font-semibold text-white">Watch Engi build software</p>
