...
function readRepository(snapshot: BitcodeTerminalShellSnapshot, repositoryContext?: TerminalRepositoryContextState | null) {
  return (
...
function readType(snapshot: BitcodeTerminalShellSnapshot) {
...
function readSummary(snapshot: BitcodeTerminalShellSnapshot, repositoryLabel: string, scenarioLabel: string, canonicalType: string) {
...
function readItemCount(snapshot: BitcodeTerminalShellSnapshot) {
...
export function buildProtocolProjectedRunDetail(
  snapshot: BitcodeTerminalShellSnapshot,
  repositoryContext?: TerminalRepositoryContextState | null,
): TerminalRunDetailSnapshot | null {
  if (!snapshot) return null;
