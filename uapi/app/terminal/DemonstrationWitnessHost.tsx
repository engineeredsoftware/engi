...
type DemonstrationWitnessHostProps = {
  className?: string;
};

export default function DemonstrationWitnessHost({
  className = '',
}: DemonstrationWitnessHostProps) {
  const rootClassName = ['bitcode-demonstration-witness-root', className].filter(Boolean).join(' ');

  return (
    <div id="bitcodeDemonstrationRoot" className={rootClassName} data-bitcode-demonstration-witness-host="mounted-demonstration-witness">
      <div className="page">
          ...
          <section className="panel" id="panelDepositing">
            ...
            <form id="depositForm" className="stack compact">
              ...
              <div className="section-card">
                ...
                <div className="mini-grid two-up">
                  <label className="field-stack">
                    ...
                    <input id="inventorySearchInput" placeholder="Filter by title, path, workflow run, or tag" />
                  </label>
                  <label className="field-stack">
              ...
              <label className="field-stack">
                ...
                <textarea name="visualPreview" rows={3} placeholder="Human-readable summary used in visual mode" />
              </label>
              <label className="field-stack">
                <span data-explainer-key="operator-note">Working note</span>
                <textarea name="operatorNote" rows={3} placeholder="Optional note appended to selected repo artifacts" />
              </label>
              <label className="field-stack">
                <span data-explainer-key="raw-fallback">Raw fallback / supplemental source material</span>
                <textarea name="content" rows={5} placeholder="Optional if selecting repo artifacts" />
              </label>
