...
export function normalizeTerminalCommandState(snapshot: ShellSnapshot): TerminalCommandState | null {
  ...
  return {
    ...
    heroTip:
      ...
      'The current flow guidance and witness signals are loading.',
    status:
