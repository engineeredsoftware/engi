...
exports.parseStreamChunk = void 0;
function pickCanonicalProcessingStats(processingStats) {
...
function normalizeAssetPackSurface(surface, fileChanges, summary) {
        ...
        try {
            ...
            switch (data.type) {
                ...
                case 'generation': {
                    ...
                    if (data.metadata)
                        parsedData.metadata = data.metadata;
                    break;
                }
                case 'tool-use': {
                    ...
                    if (data.result) {
                        ...
                        const writtenAssets = explicitWrittenAssets ||
                            ...
                            (data.result.summary || semanticFileChanges
                                ...
                                : null);
                        const deliveryMechanism = explicitDeliveryMechanism ||
                            explicitShippables ||
                            actionsSurface;
                        const shippables = explicitShippables ||
                            deliveryMechanism;
