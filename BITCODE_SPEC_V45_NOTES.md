...
V44 promotes the scaled engineering economy: `/packs` as portfolio and market
...
## Candidate V45 workstreams

- Protocol completeness: audit the V44 canon for AssetPack synthesis, BTD
...
- Do not implement V45 gate behavior before the V45 intent discussion is
  completed.
- Do not rename V44 canon surfaces while the active canonical pointer remains
  V44.
