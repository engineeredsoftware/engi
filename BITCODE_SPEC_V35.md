...
Primary V35 types: `TelemetryTaxonomyCatalog`, `DocumentationSurfaceCatalog`, `DocsQaAlignmentReport`, `OperatorRunbookCatalog`, `TestnetRolloutReadinessGuide`, `TelemetryDocumentationInterfaceIntegration`, and `DocumentationTelemetryPromotionReadinessReport`.
