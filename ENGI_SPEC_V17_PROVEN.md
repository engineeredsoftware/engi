# ENGI Spec V17 Proven

- canonicalVersion: `V17`
- canonicalCommit: `d418ec9ed34d0773799c3c86f8f5738091919a2c`
- canonicalCommitRecordedAt: `2026-04-09T16:26:19-03:00`
- worktreeState: `dirty-preview`
- generatorId: `engi-demo.proven-generator.v1`
- generatedAt: `2026-04-09T16:26:19-03:00`
- outputPath: `ENGI_SPEC_V17_PROVEN.md`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `auth-issuer-rollback` | `patch` | `need_auth-issuer-rollback_81af66a362` | `engi/remediation-need_auth-issuer-rollback_81af66a362-auth-issuer-rollback` | `asset_pack_bd3a6720143b` | 9 | `true` | `true` | 46 | 43 | `true` |
| `auth-issuer-rollback` | `context` | `need_auth-issuer-rollback_81af66a362` | `engi/remediation-need_auth-issuer-rollback_81af66a362-auth-issuer-rollback` | `asset_pack_c8a7bec57603` | 9 | `true` | `true` | 46 | 43 | `true` |
| `rust-validator-proof-gap` | `patch` | `need_rust-validator-proof-gap_89935a9470` | `engi/remediation-need_rust-validator-proof-gap_89935a9470-rust-validator-proof-gap` | `asset_pack_9ee7ff9bb9bc` | 9 | `true` | `true` | 46 | 43 | `true` |
| `rust-validator-proof-gap` | `context` | `need_rust-validator-proof-gap_89935a9470` | `engi/remediation-need_rust-validator-proof-gap_89935a9470-rust-validator-proof-gap` | `asset_pack_9ee7ff9bb9bc` | 9 | `true` | `true` | 46 | 43 | `true` |
| `config-policy-precedence-incident` | `patch` | `need_config-policy-precedence-incident_fda9bc8068` | `engi/remediation-need_config-policy-precedence-incident_fda9bc8068-config-policy-precedence-incident` | `asset_pack_83536cbc4e2b` | 9 | `true` | `true` | 46 | 43 | `true` |
| `config-policy-precedence-incident` | `context` | `need_config-policy-precedence-incident_fda9bc8068` | `engi/remediation-need_config-policy-precedence-incident_fda9bc8068-config-policy-precedence-incident` | `asset_pack_83536cbc4e2b` | 9 | `true` | `true` | 46 | 43 | `true` |
| `unsafe-patch-review-recovery` | `patch` | `need_unsafe-patch-review-recovery_5e7450e3af` | `engi/remediation-need_unsafe-patch-review-recovery_5e7450e3af-unsafe-patch-review-recovery` | `asset_pack_f6985f8e0e79` | 9 | `true` | `true` | 46 | 43 | `true` |
| `unsafe-patch-review-recovery` | `context` | `need_unsafe-patch-review-recovery_5e7450e3af` | `engi/remediation-need_unsafe-patch-review-recovery_5e7450e3af-unsafe-patch-review-recovery` | `asset_pack_f6985f8e0e79` | 9 | `true` | `true` | 46 | 43 | `true` |
| `infra-deployment-mismatch` | `patch` | `need_infra-deployment-mismatch_fc5c599b31` | `engi/remediation-need_infra-deployment-mismatch_fc5c599b31-infra-deployment-mismatch` | `asset_pack_d72be312e67f` | 9 | `true` | `true` | 46 | 43 | `true` |
| `infra-deployment-mismatch` | `context` | `need_infra-deployment-mismatch_fc5c599b31` | `engi/remediation-need_infra-deployment-mismatch_fc5c599b31-infra-deployment-mismatch` | `asset_pack_d72be312e67f` | 9 | `true` | `true` | 46 | 43 | `true` |
| `privacy-boundary-proof-export` | `patch` | `need_privacy-boundary-proof-export_4b53f9e7b1` | `engi/remediation-need_privacy-boundary-proof-export_4b53f9e7b1-privacy-boundary-proof-export` | `asset_pack_13d8cd4543f8` | 9 | `true` | `true` | 46 | 43 | `true` |
| `privacy-boundary-proof-export` | `context` | `need_privacy-boundary-proof-export_4b53f9e7b1` | `engi/remediation-need_privacy-boundary-proof-export_4b53f9e7b1-privacy-boundary-proof-export` | `asset_pack_13d8cd4543f8` | 9 | `true` | `true` | 46 | 43 | `true` |
| `polyglot-gateway-benchmark-remediation` | `patch` | `need_polyglot-gateway-benchmark-remediation_c94ea2defd` | `engi/remediation-need_polyglot-gateway-benchmark-remediation_c94ea2defd-polyglot-gateway-benchmark-remediation` | `asset_pack_6c4cb819a469` | 9 | `true` | `true` | 46 | 43 | `true` |
| `polyglot-gateway-benchmark-remediation` | `context` | `need_polyglot-gateway-benchmark-remediation_c94ea2defd` | `engi/remediation-need_polyglot-gateway-benchmark-remediation_c94ea2defd-polyglot-gateway-benchmark-remediation` | `asset_pack_6c4cb819a469` | 9 | `true` | `true` | 46 | 43 | `true` |
| `auth-many-asset-normalization` | `patch` | `need_auth-many-asset-normalization_7721dc16cb` | `engi/remediation-need_auth-many-asset-normalization_7721dc16cb-auth-many-asset-normalization` | `asset_pack_55e928ab676b` | 9 | `true` | `true` | 46 | 43 | `true` |
| `auth-many-asset-normalization` | `context` | `need_auth-many-asset-normalization_7721dc16cb` | `engi/remediation-need_auth-many-asset-normalization_7721dc16cb-auth-many-asset-normalization` | `asset_pack_55e928ab676b` | 9 | `true` | `true` | 46 | 43 | `true` |
...
- proofContractHash: `sha256:d248ed5c07121d9cafe5f7fea92a7c874876c25bfe6bec5deaed8b49b658f939`
...
| `proof-contract` | `sha256:d248ed5c07121d9cafe5f7fea92a7c874876c25bfe6bec5deaed8b49b658f939` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:d5d6476eecc28cc0277e789e4144894f4839a2fa19da1483831f9d569e833e20` | `proof-contract` | `private-proof-artifact` | `false` |
...
- proofContractHash: `sha256:4656257b28fa4bc2afbdf1d2bcb6b1ea9179a49fc356d00d99c7db2d7e9d4772`
- allFamiliesPassed: `true`
- proofContractPassed: `true`
...
| `proof-contract` | `sha256:4656257b28fa4bc2afbdf1d2bcb6b1ea9179a49fc356d00d99c7db2d7e9d4772` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:1ab3f6db9b077b3dc3bee7ed60f0f724979d0ae2a670e6192006b51716a74474` | `proof-contract` | `private-proof-artifact` | `false` |
| `.engi/static-heuristics-registry.json` | `sha256:1087a7895fdbff5f6c6b277a2f689b9598303187a4963ea333dcf57c7a04f60e` | `static-code-analysis` | `bounded-public-proof-metadata` | `true` |
...
- proofContractHash: `sha256:b8efa7a0e64d3fdbad7074f780289943834ccc5c7c29c9adb611025c2554916e`
- allFamiliesPassed: `true`
- proofContractPassed: `true`
...
| `proof-contract` | `sha256:b8efa7a0e64d3fdbad7074f780289943834ccc5c7c29c9adb611025c2554916e` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:6d14b56274ee75fcd6d33e27bfbe4d74d4af06c3fdb7c664fbc26a030e603e49` | `proof-contract` | `private-proof-artifact` | `false` |
...
- proofContractHash: `sha256:9e0f5db68a8cce39d91f7452bd1a5f40b25cbfb264b30f2af9cbab0056e83bf8`
- allFamiliesPassed: `true`
- proofContractPassed: `true`
...
| `proof-contract` | `sha256:9e0f5db68a8cce39d91f7452bd1a5f40b25cbfb264b30f2af9cbab0056e83bf8` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:6411975ef7d9390a880f4e4d25d765d49dc9b1bff2f144f45bbca2cb897e7b58` | `proof-contract` | `private-proof-artifact` | `false` |
...
- proofContractHash: `sha256:9276653001ba9fe694e160a011c77a5a57316a37888aba33cd92eb87435878b8`
- allFamiliesPassed: `true`
- proofContractPassed: `true`
...
| `proof-contract` | `sha256:9276653001ba9fe694e160a011c77a5a57316a37888aba33cd92eb87435878b8` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:c08a050a3355c21dbbb8ec18a72717c0d4469359a25e0abd06ae2bf50ca69574` | `proof-contract` | `private-proof-artifact` | `false` |
...
- proofContractHash: `sha256:f94cb2455343735a526128202c066518682a1a1c82c2c2d41bd9a063515e3c7b`
- allFamiliesPassed: `true`
- proofContractPassed: `true`
...
| `proof-contract` | `sha256:f94cb2455343735a526128202c066518682a1a1c82c2c2d41bd9a063515e3c7b` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:12f05304b5eb45d9fb197370b3df600df932650a64b25009f464fd95810196f6` | `proof-contract` | `private-proof-artifact` | `false` |
...
- proofContractHash: `sha256:7cea5e1406412dfb9491a99dfb94efd9eb4ee6ef2ec71edfa2a302c3f9a4a57d`
- allFamiliesPassed: `true`
- proofContractPassed: `true`
...
| `proof-contract` | `sha256:7cea5e1406412dfb9491a99dfb94efd9eb4ee6ef2ec71edfa2a302c3f9a4a57d` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:4cc8fb1b30bc4680ff790438b475640e869ac86b499bffa04fecd077cfdbf556` | `proof-contract` | `private-proof-artifact` | `false` |
...
- proofContractHash: `sha256:2fd75404871493eb74b2e4f36b7743115f4c35e715dc0ef724e95105a102d0a8`
- allFamiliesPassed: `true`
- proofContractPassed: `true`
...
| `proof-contract` | `sha256:2fd75404871493eb74b2e4f36b7743115f4c35e715dc0ef724e95105a102d0a8` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:9d059b779c14729ab2f0516b871d5bcfcdead54840d8a5b83174f7267ccad98b` | `proof-contract` | `private-proof-artifact` | `false` |
...
- proofContractHash: `sha256:6fec2f91aff7acdf2937ae67ccbb6e98801ede8a9b0d6b2f9d897f63a9dbd6da`
- allFamiliesPassed: `true`
- proofContractPassed: `true`
...
| `proof-contract` | `sha256:6fec2f91aff7acdf2937ae67ccbb6e98801ede8a9b0d6b2f9d897f63a9dbd6da` | `.engi/proof-contract.json` |
...
| `.engi/proof-contract.json` | `sha256:1e25c06a3aeee9ca7bad72f62c506da3ba700ccdee30cbe00016282447cde6ab` | `proof-contract` | `private-proof-artifact` | `false` |
