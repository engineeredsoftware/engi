...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('roadmap-advanced-through-gate4', 'SPECIFICATIONS_ROADMAP.md', roadmap.includes('Current working gate: V40 Gate 4') && roadmap.includes('V40 Gate 4 closure anchor')),
