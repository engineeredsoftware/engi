...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('roadmap-advanced-to-gate9', SOURCE_ROOTS.roadmap, sources.roadmap.includes('Current working gate: V43 Gate 9') && sources.roadmap.includes('V43 Gate 9 closure anchor')),
