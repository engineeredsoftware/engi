...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('roadmap-advanced-to-gate7', SOURCE_ROOTS.roadmap, /Current working gate: V39 Gate (?:7|8|9|10|11)\b/u.test(roadmap) && roadmap.includes('V39 Gate 7 closure anchor')),
