...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('roadmap-advanced-through-gate6', SOURCE_ROOTS.roadmap, roadmap.includes('V39 Gate 6 closure anchor') && (/Current working gate: V39 Gate (?:7|8|9|10|11)\b/u.test(roadmap) || roadmap.includes('Latest closed version: V39 Commercial Reading Readiness'))),
