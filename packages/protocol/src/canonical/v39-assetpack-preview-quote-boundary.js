...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('roadmap-advanced-to-gate6', SOURCE_ROOTS.roadmap, roadmap.includes('Current working gate: V39 Gate 6') && roadmap.includes('V39 Gate 6 closure anchor')),
