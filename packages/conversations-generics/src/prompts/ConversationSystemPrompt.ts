...
import { PROMPTPART_SPECIFIC_SYSTEM_CONVERSATIONSPRODUCT_IDENTITY_CORESTATEMENT } from '@engi/prompts/src/raw_promptparts/specific/promptpart_specific_system_conversationsproduct_identity_corestatement';
import { PROMPTPART_SPECIFIC_SYSTEM_CONVERSATIONSPRODUCT_CAPABILITIES_LIST } from '@engi/prompts/src/raw_promptparts/specific/promptpart_specific_system_conversationsproduct_capabilities_list';
import { PROMPTPART_SPECIFIC_SYSTEM_CONVERSATIONSPRODUCT_USAGE_GUIDANCE } from '@engi/prompts/src/raw_promptparts/specific/promptpart_specific_system_conversationsproduct_usage_guidance';
