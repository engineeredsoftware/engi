...
This file records demo-local realization parity for `packages/bitcode/`.
...
- demo realization truth lives here under `packages/bitcode/`,
...
3. `packages/bitcode/src/bitcode-demo.js` is still the main orchestration reservoir even though `src/canonical/surfaces.js`, `src/canonical/run-artifacts.js`, `src/canonical/projections.js`, `src/canonical/proof-materialization.js`, and `src/demo-shell-state.js` now isolate major builder families.
