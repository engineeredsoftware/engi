...
export declare const transform: <TIn, TOut, UIn, UOut>(executor: Executor<UIn, UOut>, mapInput: (input: TIn) => UIn | Promise<UIn>, mapOutput: (output: UOut) => TOut | Promise<TOut>) => Executor<TIn, TOut>;
