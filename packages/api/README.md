...
Its job is to make the merged-world Terminal concrete without flattening package boundaries that still serve the Bitcode system.
...
import { readBtdHoldings } from '@bitcode/btd';
