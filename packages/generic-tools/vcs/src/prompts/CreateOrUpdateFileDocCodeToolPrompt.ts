...
import { PROMPTPART_SPECIFIC_TOOL_CREATEORUPDATEFILE_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_createorupdatefile_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_CREATEORUPDATEFILE_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_createorupdatefile_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_CREATEORUPDATEFILE_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_createorupdatefile_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_CREATEORUPDATEFILE_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_createorupdatefile_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_CREATEORUPDATEFILE_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_createorupdatefile_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_CREATEORUPDATEFILE_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_createorupdatefile_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_CREATEORUPDATEFILE_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_createorupdatefile_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_CREATEORUPDATEFILE_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_createorupdatefile_doccodetoolexample3';
/**
