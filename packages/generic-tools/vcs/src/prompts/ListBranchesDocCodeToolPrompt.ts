...
import { PROMPTPART_SPECIFIC_TOOL_LISTBRANCHES_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_listbranches_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_LISTBRANCHES_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_listbranches_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_LISTBRANCHES_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_listbranches_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_LISTBRANCHES_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_listbranches_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_LISTBRANCHES_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_listbranches_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_LISTBRANCHES_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_listbranches_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_LISTBRANCHES_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_listbranches_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_LISTBRANCHES_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_listbranches_doccodetoolexample3';
/**
