...
import { PROMPTPART_SPECIFIC_TOOL_CREATEISSUE_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createissue_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_CREATEISSUE_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createissue_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_CREATEISSUE_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createissue_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_CREATEISSUE_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createissue_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_CREATEISSUE_DOCCODETOOLOUTPUT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createissue_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_CREATEISSUE_DOCCODETOOLEXAMPLE1 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createissue_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_CREATEISSUE_DOCCODETOOLEXAMPLE2 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createissue_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_CREATEISSUE_DOCCODETOOLEXAMPLE3 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createissue_doccodetoolexample3';
/**
