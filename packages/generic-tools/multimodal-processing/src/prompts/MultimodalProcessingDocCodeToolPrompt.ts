...
import { PROMPTPART_SPECIFIC_TOOL_MULTIMODALPROCESSING_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_multimodalprocessing_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_MULTIMODALPROCESSING_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_multimodalprocessing_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_MULTIMODALPROCESSING_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_multimodalprocessing_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_MULTIMODALPROCESSING_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_multimodalprocessing_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_MULTIMODALPROCESSING_DOCCODETOOLOUTPUT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_multimodalprocessing_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_MULTIMODALPROCESSING_DOCCODETOOLEXAMPLE1 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_multimodalprocessing_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_MULTIMODALPROCESSING_DOCCODETOOLEXAMPLE2 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_multimodalprocessing_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_MULTIMODALPROCESSING_DOCCODETOOLEXAMPLE3 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_multimodalprocessing_doccodetoolexample3';
/**
