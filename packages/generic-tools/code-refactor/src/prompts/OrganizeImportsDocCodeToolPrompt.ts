...
import { PROMPTPART_SPECIFIC_TOOL_ORGANIZEIMPORTS_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_organizeimports_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_ORGANIZEIMPORTS_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_organizeimports_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_ORGANIZEIMPORTS_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_organizeimports_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_ORGANIZEIMPORTS_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_organizeimports_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_ORGANIZEIMPORTS_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_organizeimports_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_ORGANIZEIMPORTS_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_organizeimports_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_ORGANIZEIMPORTS_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_organizeimports_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_ORGANIZEIMPORTS_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_organizeimports_doccodetoolexample3';
/**
