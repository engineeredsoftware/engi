...
import { PROMPTPART_SPECIFIC_TOOL_RENAMESYMBOL_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_renamesymbol_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_RENAMESYMBOL_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_renamesymbol_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_RENAMESYMBOL_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_renamesymbol_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_RENAMESYMBOL_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_renamesymbol_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_RENAMESYMBOL_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_renamesymbol_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_RENAMESYMBOL_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_renamesymbol_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_RENAMESYMBOL_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_renamesymbol_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_RENAMESYMBOL_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_renamesymbol_doccodetoolexample3';
/**
