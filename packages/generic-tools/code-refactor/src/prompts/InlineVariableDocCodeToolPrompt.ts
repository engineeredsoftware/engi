...
import { PROMPTPART_SPECIFIC_TOOL_INLINEVARIABLE_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_inlinevariable_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_INLINEVARIABLE_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_inlinevariable_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_INLINEVARIABLE_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_inlinevariable_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_INLINEVARIABLE_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_inlinevariable_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_INLINEVARIABLE_DOCCODETOOLOUTPUT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_inlinevariable_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_INLINEVARIABLE_DOCCODETOOLEXAMPLE1 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_inlinevariable_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_INLINEVARIABLE_DOCCODETOOLEXAMPLE2 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_inlinevariable_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_INLINEVARIABLE_DOCCODETOOLEXAMPLE3 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_inlinevariable_doccodetoolexample3';
/**
