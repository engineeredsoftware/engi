 ...
 * criteria for written assets, proofs, persistence, and delivery wrappers.
 */
export class GenerateNeedSatisfactionCriteriaDocCodeToolPrompt extends DocCodeToolPrompt {
  constructor() {
    ...
    this.set(
      'metadata:version',
      'BITCODE_V26_GENERATE_NEED_SATISFACTION_CRITERIA_DOC_CODE_TOOL_PROMPT_REGISTRY.1' as PromptPart
    );
...
export const GENERATE_NEED_SATISFACTION_CRITERIA_DOC_CODE_TOOL_PROMPT =
  new GenerateNeedSatisfactionCriteriaDocCodeToolPrompt();
