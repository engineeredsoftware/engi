...
import { PROMPTPART_SPECIFIC_TOOL_FIGMAMCP_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_figmamcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_FIGMAMCP_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_figmamcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_FIGMAMCP_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_figmamcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_FIGMAMCP_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_figmamcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_FIGMAMCP_DOCCODETOOLOUTPUT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_figmamcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_FIGMAMCP_DOCCODETOOLEXAMPLE1 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_figmamcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_FIGMAMCP_DOCCODETOOLEXAMPLE2 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_figmamcp_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_FIGMAMCP_DOCCODETOOLEXAMPLE3 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_figmamcp_doccodetoolexample3';
/**
