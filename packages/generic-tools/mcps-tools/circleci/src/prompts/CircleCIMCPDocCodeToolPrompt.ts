...
import { PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_circlecimcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_circlecimcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_circlecimcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_circlecimcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLOUTPUT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_circlecimcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLEXAMPLE1 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_circlecimcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLEXAMPLE2 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_circlecimcp_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLEXAMPLE3 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_circlecimcp_doccodetoolexample3';
/**
