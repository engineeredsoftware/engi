...
import { PROMPTPART_SPECIFIC_TOOL_KUBERNETESMCP_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_kubernetesmcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_KUBERNETESMCP_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_kubernetesmcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_KUBERNETESMCP_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_kubernetesmcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_KUBERNETESMCP_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_kubernetesmcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_KUBERNETESMCP_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_kubernetesmcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_KUBERNETESMCP_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_kubernetesmcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_KUBERNETESMCP_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_kubernetesmcp_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_KUBERNETESMCP_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_kubernetesmcp_doccodetoolexample3';
/**
