...
import { PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_mysqlmcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_mysqlmcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_mysqlmcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_mysqlmcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_mysqlmcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_mysqlmcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_mysqlmcp_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_mysqlmcp_doccodetoolexample3';
/**
