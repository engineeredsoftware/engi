...
import { PROMPTPART_SPECIFIC_TOOL_AWSMCP_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_awsmcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_AWSMCP_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_awsmcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_AWSMCP_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_awsmcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_AWSMCP_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_awsmcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_AWSMCP_DOCCODETOOLOUTPUT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_awsmcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_AWSMCP_DOCCODETOOLEXAMPLE1 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_awsmcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_AWSMCP_DOCCODETOOLEXAMPLE2 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_awsmcp_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_AWSMCP_DOCCODETOOLEXAMPLE3 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_awsmcp_doccodetoolexample3';
/**
