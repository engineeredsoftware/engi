...
import { PROMPTPART_SPECIFIC_TOOL_GITHUBMCP_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_githubmcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_GITHUBMCP_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_githubmcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_GITHUBMCP_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_githubmcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_GITHUBMCP_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_githubmcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_GITHUBMCP_DOCCODETOOLOUTPUT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_githubmcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_GITHUBMCP_DOCCODETOOLEXAMPLE1 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_githubmcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_GITHUBMCP_DOCCODETOOLEXAMPLE2 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_githubmcp_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_GITHUBMCP_DOCCODETOOLEXAMPLE3 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_githubmcp_doccodetoolexample3';
/**
