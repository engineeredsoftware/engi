...
import { PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitlabmcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitlabmcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitlabmcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitlabmcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitlabmcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitlabmcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitlabmcp_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitlabmcp_doccodetoolexample3';
/**
