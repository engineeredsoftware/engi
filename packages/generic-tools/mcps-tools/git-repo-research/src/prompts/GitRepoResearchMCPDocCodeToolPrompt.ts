...
import { PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitreporesearchmcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitreporesearchmcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitreporesearchmcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitreporesearchmcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitreporesearchmcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitreporesearchmcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitreporesearchmcp_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_gitreporesearchmcp_doccodetoolexample3';
/**
