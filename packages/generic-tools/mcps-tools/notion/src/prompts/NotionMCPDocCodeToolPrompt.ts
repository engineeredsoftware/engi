...
import { PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_notionmcp_doccodetoolexample3';
import { PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_notionmcp_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_notionmcp_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_notionmcp_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_notionmcp_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_notionmcp_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_notionmcp_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_notionmcp_doccodetoolexample2';
/**
