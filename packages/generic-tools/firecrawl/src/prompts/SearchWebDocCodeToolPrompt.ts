...
import { PROMPTPART_SPECIFIC_TOOL_SEARCHWEB_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_searchweb_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_SEARCHWEB_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_searchweb_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_SEARCHWEB_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_searchweb_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_SEARCHWEB_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_searchweb_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_SEARCHWEB_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_searchweb_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_SEARCHWEB_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_searchweb_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_SEARCHWEB_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_searchweb_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_SEARCHWEB_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_searchweb_doccodetoolexample3';
/**
