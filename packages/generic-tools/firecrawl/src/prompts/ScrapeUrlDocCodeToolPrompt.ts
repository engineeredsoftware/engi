...
import { PROMPTPART_SPECIFIC_TOOL_SCRAPEURL_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_scrapeurl_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_SCRAPEURL_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_scrapeurl_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_SCRAPEURL_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_scrapeurl_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_SCRAPEURL_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_scrapeurl_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_SCRAPEURL_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_scrapeurl_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_SCRAPEURL_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_scrapeurl_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_SCRAPEURL_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_scrapeurl_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_SCRAPEURL_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_scrapeurl_doccodetoolexample3';
/**
