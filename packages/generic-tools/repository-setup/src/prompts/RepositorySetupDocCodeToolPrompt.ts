...
import { PROMPTPART_SPECIFIC_TOOL_REPOSITORYSETUP_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_repositorysetup_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_REPOSITORYSETUP_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_repositorysetup_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_REPOSITORYSETUP_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_repositorysetup_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_REPOSITORYSETUP_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_repositorysetup_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_REPOSITORYSETUP_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_repositorysetup_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_REPOSITORYSETUP_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_repositorysetup_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_REPOSITORYSETUP_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_repositorysetup_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_REPOSITORYSETUP_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_repositorysetup_doccodetoolexample3';
/**
