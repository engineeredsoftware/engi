...
import { PROMPTPART_SPECIFIC_TOOL_DELETEFILE_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_deletefile_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_DELETEFILE_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_deletefile_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_DELETEFILE_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_deletefile_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_DELETEFILE_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_deletefile_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_DELETEFILE_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_deletefile_doccodetooloutput';
