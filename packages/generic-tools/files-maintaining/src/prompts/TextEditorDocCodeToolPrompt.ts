...
import { PROMPTPART_SPECIFIC_TOOL_TEXTEDITOR_DOCCODETOOLNAME } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_texteditor_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_TEXTEDITOR_DOCCODETOOLPURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_texteditor_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_TEXTEDITOR_DOCCODETOOLCAPABILITIES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_texteditor_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_TEXTEDITOR_DOCCODETOOLPARAMETERS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_texteditor_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_TEXTEDITOR_DOCCODETOOLOUTPUT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_texteditor_doccodetooloutput';
import { PROMPTPART_SPECIFIC_TOOL_TEXTEDITOR_DOCCODETOOLEXAMPLE1 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_texteditor_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_TEXTEDITOR_DOCCODETOOLEXAMPLE2 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_texteditor_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_TEXTEDITOR_DOCCODETOOLEXAMPLE3 } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_tool_texteditor_doccodetoolexample3';
/**
