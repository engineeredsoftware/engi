...
import { PROMPTPART_SPECIFIC_TOOL_CREATEFILE_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createfile_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_CREATEFILE_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createfile_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_CREATEFILE_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createfile_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_CREATEFILE_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_createfile_doccodetoolparameters';
 ...
 * domain: tool
 * intent: "Bitcode written-asset file mutation support prompt for atomic file creation"
 * current_version: "V26"
 * versions: []
 */
