...
/**
 * BITCODE READ-SYNTHESIS WEB SEARCH DOC-CODE-TOOL PROMPT
 * 
...
/**
 * Bitcode read-synthesis web search tool-specific DocCodeToolPrompt
 * 
 * @doc-comment-developing-promptdevelopment
 * versions: []
 * domain: tool
 * intent: "Bitcode discovery-phase web search tool prompt for source-attributed read-synthesis evidence"
 * 
 * This support prompt injects web-search capabilities only as
 * bounded external evidence support for Bitcode read synthesis.
 */
export class WebSearchDocCodeToolPrompt extends DocCodeToolPrompt {
  constructor() {
    ...
    this.set('metadata:category', 'bitcode-read-synthesis-web-search' as PromptPart);
    ...
    // Add examples scoped to Bitcode read-synthesis evidence use.
