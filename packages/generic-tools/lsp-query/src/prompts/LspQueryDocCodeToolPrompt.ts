...
import { PROMPTPART_SPECIFIC_TOOL_LSPQUERY_DOCCODETOOLNAME } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_lspquery_doccodetoolname';
import { PROMPTPART_SPECIFIC_TOOL_LSPQUERY_DOCCODETOOLPURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_lspquery_doccodetoolpurpose';
import { PROMPTPART_SPECIFIC_TOOL_LSPQUERY_DOCCODETOOLCAPABILITIES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_lspquery_doccodetoolcapabilities';
import { PROMPTPART_SPECIFIC_TOOL_LSPQUERY_DOCCODETOOLPARAMETERS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_lspquery_doccodetoolparameters';
import { PROMPTPART_SPECIFIC_TOOL_LSPQUERY_DOCCODETOOLOUTPUT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_lspquery_doccodetooloutput';
/**
...
import { PROMPTPART_SPECIFIC_TOOL_LSPQUERY_DOCCODETOOLEXAMPLE1 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_lspquery_doccodetoolexample1';
import { PROMPTPART_SPECIFIC_TOOL_LSPQUERY_DOCCODETOOLEXAMPLE2 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_lspquery_doccodetoolexample2';
import { PROMPTPART_SPECIFIC_TOOL_LSPQUERY_DOCCODETOOLEXAMPLE3 } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_lspquery_doccodetoolexample3';
