 ...
 */
import { SDIVSPhase } from '@bitcode/pipelines-generics';
...
export declare class GenericStreamManager {
     ...
     */
    phaseStart(phase: SDIVSPhase | string): Promise<void>;
    phaseComplete(phase: SDIVSPhase | string, result?: any): Promise<void>;
    /**
     * @doc-stream
