...
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_system_role';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_system_instructions';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_PLAN_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_plan_strategy';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_PLAN_ANALYSIS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_plan_analysis';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_TRY_DIRECTIVES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_try_directives';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_REFINE_OPTIMIZATION } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_refine_optimization';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_REFINE_ASSESSMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_refine_assessment';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_RETRY_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_retry_strategy';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_RETRY_ERRORHANDLING } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_retry_errorhandling';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_CONTEXT_AWARENESS_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_context_awareness_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_PHASE_PLAN_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_phase_plan_label';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_PHASE_TRY_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_phase_try_label';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_PHASE_REFINE_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_phase_refine_label';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_PHASE_RETRY_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_phase_retry_label';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_PLAN_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_plan_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_TRY_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_try_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_REFINE_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_refine_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_DIVIDECODECHANGE_RETRY_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dividecodechange_retry_output_requirement_detailcontent';
