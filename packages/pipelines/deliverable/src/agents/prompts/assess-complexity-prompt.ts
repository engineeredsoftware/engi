...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_IDENTITY_DEFINITION } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_identity_definition';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_TOOLS_AVAILABLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_tools_available';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_REQUIREMENTS_CONTEXT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_requirements_context';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_PTRRPLAN_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_ptrrplan_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_PTRRTRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_ptrrtry_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_PTRRREFINE_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_ptrrrefine_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYASSESSCOMPLEXITY_PTRRRETRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoveryassesscomplexity_ptrrretry_purpose';
 ...
 * domain: pipeline
 * intent: "Deliverables Discovery – Assess Complexity agent prompt"
