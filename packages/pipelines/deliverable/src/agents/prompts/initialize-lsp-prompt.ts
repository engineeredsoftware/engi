...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_IDENTITY_DEFINITION } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_identity_definition';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_PURPOSE_CORESTATEMENT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_CAPABILITIES_LIST } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_TOOLS_AVAILABLE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_tools_available';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_REQUIREMENTS_CONTEXT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_requirements_context';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_PTRRPLAN_PURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_ptrrplan_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_PTRRTRY_PURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_ptrrtry_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_PTRRREFINE_PURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_ptrrrefine_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPINITIALIZELSP_PTRRRETRY_PURPOSE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupinitializelsp_ptrrretry_purpose';
 ...
 * domain: pipeline
 * intent: "Bitcode setup/support compatibility prompt for initializing LSP evidence used by code-oriented AssetPack runs"
