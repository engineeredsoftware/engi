...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYCOMPREHENDATTACHMENTS_IDENTITY_DEFINITION } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoverycomprehendattachments_identity_definition';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYCOMPREHENDATTACHMENTS_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoverycomprehendattachments_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYCOMPREHENDATTACHMENTS_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoverycomprehendattachments_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYCOMPREHENDATTACHMENTS_TOOLS_AVAILABLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoverycomprehendattachments_tools_available';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYCOMPREHENDATTACHMENTS_REQUIREMENTS_CONTEXT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoverycomprehendattachments_requirements_context';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYCOMPREHENDATTACHMENTS_PTRRPLAN_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoverycomprehendattachments_ptrrplan_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYCOMPREHENDATTACHMENTS_PTRRTRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoverycomprehendattachments_ptrrtry_purpose';
...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEDISCOVERYCOMPREHENDATTACHMENTS_PTRRRETRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablediscoverycomprehendattachments_ptrrretry_purpose';
 ...
 * domain: pipeline
 * intent: "Deliverables Discovery – Comprehend Attachments agent prompt"
 ...
 * ]
 */
export function createDeliverablesPipelineDiscoveryPhaseComprehendAttachmentsAgentPrompt(): Prompt {
 ...
 */
export const DeliverablesPipelineDiscoveryPhaseComprehendAttachmentsAgentPromptSteps = {
  plan: () => {
    const prompt = new Prompt();
