...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_SYSTEM_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_system_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_SYSTEM_CONSTRAINTS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_system_constraints';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_PLAN_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_plan_label';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_PLAN_DETAILS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_plan_details';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_TRY_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_try_label';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_TRY_DETAILS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_try_details';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_REFINE_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_refine_label';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_REFINE_DETAILS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_refine_details';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_RETRY_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_retry_label';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESPIPELINE_CLONEVCSREPOSITORY_RETRY_DETAILS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablespipeline_clonevcsrepository_retry_details';
/**
