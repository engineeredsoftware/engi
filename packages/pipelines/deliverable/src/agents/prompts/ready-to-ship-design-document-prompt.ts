...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_IDENTITY_DEFINITION } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_identity_definition';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_TOOLS_AVAILABLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_tools_available';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_REQUIREMENTS_CONTEXT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_requirements_context';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_PTRRPLAN_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_ptrrplan_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_PTRRTRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_ptrrtry_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_PTRRREFINE_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_ptrrrefine_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLEVALIDATIONREADYTOSHIPDESIGNDOCUMENT_PTRRRETRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablevalidationreadytoshipdesigndocument_ptrrretry_purpose';
