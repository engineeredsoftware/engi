...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_IDENTITY_DEFINITION } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_identity_definition';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_TOOLS_AVAILABLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_tools_available';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_REQUIREMENTS_CONTEXT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_requirements_context';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_PTRRPLAN_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_ptrrplan_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_PTRRTRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_ptrrtry_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_PTRRREFINE_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_ptrrrefine_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_PTRRRETRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupdangerwall_ptrrretry_purpose';
 ...
 * domain: pipeline
 * intent: "Deliverables – DangerWall agent prompt"
 ...
 * ]
 */
export function createDeliverablesPipelineSetupPhaseDangerWallAgentPrompt(): Prompt {
 ...
 */
export const DeliverablesPipelineSetupPhaseDangerWallAgentPromptSteps = {
  plan: () => {
    const prompt = new Prompt();
