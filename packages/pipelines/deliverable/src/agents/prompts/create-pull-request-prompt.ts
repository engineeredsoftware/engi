...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_IDENTITY_DEFINITION } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_identity_definition';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_TOOLS_AVAILABLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_tools_available';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_REQUIREMENTS_CONTEXT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_requirements_context';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_PTRRPLAN_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_ptrrplan_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_PTRRTRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_ptrrtry_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_PTRRREFINE_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_ptrrrefine_purpose';
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESHIPPINGCREATEPULLREQUEST_PTRRRETRY_PURPOSE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverableshippingcreatepullrequest_ptrrretry_purpose';
 ...
 * domain: pipeline
 * intent: "Deliverables Shipping – Create Pull Request agent prompt"
