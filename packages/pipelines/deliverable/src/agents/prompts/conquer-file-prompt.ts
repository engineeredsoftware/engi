...
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_system_role';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_system_instructions';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_PLAN_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_plan_strategy';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_PLAN_ANALYSIS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_plan_analysis';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_TRY_DIRECTIVES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_try_directives';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_REFINE_OPTIMIZATION } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_refine_optimization';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_REFINE_ASSESSMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_refine_assessment';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_RETRY_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_retry_strategy';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_RETRY_ERRORHANDLING } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_retry_errorhandling';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_CONTEXT_AWARENESS_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_context_awareness_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_PHASE_PLAN_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_phase_plan_label';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_PHASE_TRY_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_phase_try_label';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_PHASE_REFINE_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_phase_refine_label';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_PHASE_RETRY_LABEL } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_phase_retry_label';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_PLAN_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_plan_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_TRY_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_try_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_REFINE_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_refine_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_RETRY_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_conquerfile_retry_output_requirement_detailcontent';
...
// Import PromptParts from root barrel to avoid deep imports
import { // Specific: ConquerFile agent
  PROMPTPART_SPECIFIC_AGENT_CONQUERFILE_SYSTEM_IDENTITY, // Generic: PTRR and formatting
  PROMPTPART_GENERIC_PTRR_PLAN_OBJECTIVE, PROMPTPART_GENERIC_PTRR_TRY_OBJECTIVE, PROMPTPART_GENERIC_FORMATTING_EXECUTETHE_FOLLOWING } from '@engi/prompts';

/**
 * @doc-comment-developing-promptdevelopment
 * domain: pipeline
 * intent: "Deliverables – ConquerFile agent system prompt"
