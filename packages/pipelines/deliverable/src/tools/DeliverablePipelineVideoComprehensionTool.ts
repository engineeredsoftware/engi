...
import { PROMPTPART_SPECIFIC_TOOL_DELIVERABLES_VIDEOCOMPREHENSION_DOCCODETOOL_CAPABILITIES_ADDENDUM } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_tool_deliverables_videocomprehension_doccodetool_capabilities_addendum';
...
const OVERLAY: Prompt = (() => {
  ...
  p.set('capabilities:deliverables:addendum', PROMPTPART_SPECIFIC_TOOL_DELIVERABLES_VIDEOCOMPREHENSION_DOCCODETOOL_CAPABILITIES_ADDENDUM as any, 5);
  return p;
})();

export const DP_VIDEO_TOOL_PROMPT: Prompt = (() => {
...
(deliverablePipelineVideoComprehensionTool as any).name = 'deliverable-pipeline-video-comprehension-tool';
