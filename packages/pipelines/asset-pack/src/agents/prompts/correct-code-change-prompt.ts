...
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_SYSTEM_IDENTITY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_SYSTEM_ROLE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_system_role';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_SYSTEM_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_system_instructions';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_PLAN_STRATEGY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_plan_strategy';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_PLAN_ANALYSIS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_plan_analysis';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_TRY_DIRECTIVES } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_try_directives';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_REFINE_OPTIMIZATION } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_refine_optimization';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_REFINE_ASSESSMENT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_refine_assessment';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_RETRY_STRATEGY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_retry_strategy';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_RETRY_ERRORHANDLING } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_retry_errorhandling';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_CONTEXT_AWARENESS_DETAILCONTENT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_context_awareness_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_PHASE_PLAN_LABEL } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_phase_plan_label';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_PHASE_TRY_LABEL } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_phase_try_label';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_PHASE_REFINE_LABEL } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_phase_refine_label';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_PHASE_RETRY_LABEL } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_phase_retry_label';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_PLAN_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_plan_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_TRY_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_try_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_REFINE_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_refine_output_requirement_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_RETRY_OUTPUT_REQUIREMENT_DETAILCONTENT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_correctcodechange_retry_output_requirement_detailcontent';
 ...
 * domain: pipeline
 * intent: "Bitcode implementation compatibility prompt for correcting code-change AssetPack mutations against Need satisfaction and proof criteria"
