...
import { PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPCOMPREHENDNEED_OUTPUT_NEEDDEFINITIONANALYSIS_SPEC } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_deliverablesetupcomprehendneed_output_needdefinitionanalysis_spec';
...
export const DP_COMPREHEND_NEED_REFINE_PROMPT: Prompt = (() => {
  ...
  p.set('step:details:asset-pack-written-asset:addendum_output_need_definition', PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPCOMPREHENDNEED_OUTPUT_NEEDDEFINITIONANALYSIS_SPEC as any);
