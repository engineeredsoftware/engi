...
import { PROMPTPART_SPECIFIC_AGENT_DANGERWALL_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dangerwall_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_DANGERWALL_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dangerwall_system_role';
import { PROMPTPART_SPECIFIC_AGENT_DANGERWALL_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_dangerwall_system_instructions';
