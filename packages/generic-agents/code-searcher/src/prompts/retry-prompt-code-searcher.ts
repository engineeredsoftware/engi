import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_RETRY_DEEPENING_STRATEGY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_retry_deepening_strategy';
import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_RETRY_INSIGHT_EXTRACTION } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_retry_insight_extraction';
...
export const CODE_SEARCHER_RETRY_PROMPT = new Prompt()
  .set('deepening', PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_RETRY_DEEPENING_STRATEGY)
  .set('insights', PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_RETRY_INSIGHT_EXTRACTION)
