import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_TRY_DIRECTIVES_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_try_execution_instructions';
import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_TRY_SEARCH_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_try_search_strategy';
