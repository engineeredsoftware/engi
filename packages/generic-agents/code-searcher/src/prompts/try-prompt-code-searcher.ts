import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_TRY_DIRECTIVES_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_try_execution_instructions';
import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_TRY_SEARCH_STRATEGY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_try_search_strategy';
...
export const CODE_SEARCHER_TRY_PROMPT = new Prompt()
  .set('instructions', PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_TRY_DIRECTIVES_INSTRUCTIONS)
  .set('strategy', PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_TRY_SEARCH_STRATEGY)
