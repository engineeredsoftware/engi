import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_SYSTEM_IDENTITY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_SYSTEM_ROLE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_system_role';
import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_SYSTEM_CONTEXT } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_system_context';
import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_SYSTEM_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_system_instructions';
