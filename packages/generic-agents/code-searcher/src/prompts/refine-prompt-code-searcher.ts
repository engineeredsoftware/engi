import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_REFINE_QUALITY_CRITERIA } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_refine_quality_criteria';
import { PROMPTPART_SPECIFIC_AGENT_CODESEARCHER_REFINE_SCORING_APPROACH } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_codesearcher_refine_scoring_approach';
