import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_REFINE_QUALITY_CRITERIA } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_refine_quality_criteria';
import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_REFINE_INFORMATION_ENHANCEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_refine_information_enhancement';
