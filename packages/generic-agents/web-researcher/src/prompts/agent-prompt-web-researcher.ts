import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_EXECUTIONPATTERN_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_executionpattern_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_PTRRSTEPS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_ptrrsteps_list';
import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_TOOLS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_tools_list';
import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_INTEGRATION_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_integration_detailcontent';
