import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_TRY_DIRECTIVES_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_try_directives_instructions';
import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_TRY_RESEARCH_TECHNIQUES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_try_research_techniques';
