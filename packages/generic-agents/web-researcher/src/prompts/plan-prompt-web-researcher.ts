import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_PLAN_RESEARCH_ANALYSIS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_plan_research_analysis';
import { PROMPTPART_SPECIFIC_AGENT_WEBRESEARCHER_PLAN_INVESTIGATION_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_webresearcher_plan_investigation_strategy';
