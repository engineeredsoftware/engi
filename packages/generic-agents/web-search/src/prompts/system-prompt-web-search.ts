...
import { PROMPTPART_SPECIFIC_AGENT_WEB_SEARCH_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_web_search_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_WEB_SEARCH_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_web_search_system_role';
import { PROMPTPART_SPECIFIC_AGENT_WEB_SEARCH_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_web_search_system_instructions';
/**
...
export const WEB_SEARCH_SYSTEM_PROMPT = new Prompt()
  .set('identity', PROMPTPART_SPECIFIC_AGENT_WEB_SEARCH_SYSTEM_IDENTITY)
  .set('role', PROMPTPART_SPECIFIC_AGENT_WEB_SEARCH_SYSTEM_ROLE)
  .set('instructions', PROMPTPART_SPECIFIC_AGENT_WEB_SEARCH_SYSTEM_INSTRUCTIONS)
  // Generic generation and failsafe scaffolding
