...
import { PROMPTPART_SPECIFIC_AGENT_TEXTSEARCHER_TRY_DIRECTIVES_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_textsearcher_try_directives_instructions';
import { PROMPTPART_SPECIFIC_AGENT_TEXTSEARCHER_TRY_SEARCH_TECHNIQUES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_textsearcher_try_search_techniques';
/**
...
export const TEXT_SEARCHER_TRY_PROMPT = new Prompt()
  ...
  .set('techniques', PROMPTPART_SPECIFIC_AGENT_TEXTSEARCHER_TRY_SEARCH_TECHNIQUES)
