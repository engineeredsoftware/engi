...
import { PROMPTPART_SPECIFIC_AGENT_TEXTSEARCHER_REFINE_RELEVANCE_CRITERIA } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_textsearcher_refine_relevance_criteria';
import { PROMPTPART_SPECIFIC_AGENT_TEXTSEARCHER_REFINE_ACCURACY_ENHANCEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_textsearcher_refine_accuracy_enhancement';
/**
...
export const TEXT_SEARCHER_REFINE_PROMPT = new Prompt()
  ...
  .set('enhancement', PROMPTPART_SPECIFIC_AGENT_TEXTSEARCHER_REFINE_ACCURACY_ENHANCEMENT)
