...
import { PROMPTPART_SPECIFIC_AGENT_TEXT_SEARCHER_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_text_searcher_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_TEXT_SEARCHER_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_text_searcher_system_role';
import { PROMPTPART_SPECIFIC_AGENT_TEXT_SEARCHER_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_text_searcher_system_instructions';
/**
...
export const TEXT_SEARCHER_SYSTEM_PROMPT = new Prompt()
  ...
  .set('role', PROMPTPART_SPECIFIC_AGENT_TEXT_SEARCHER_SYSTEM_ROLE)
  .set('instructions', PROMPTPART_SPECIFIC_AGENT_TEXT_SEARCHER_SYSTEM_INSTRUCTIONS)
