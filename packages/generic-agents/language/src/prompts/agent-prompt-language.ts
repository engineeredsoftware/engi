import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_language_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_language_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_EXECUTIONPATTERN_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_language_executionpattern_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_PTRRSTEPS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_language_ptrrsteps_list';
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_TOOLS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_language_tools_list';
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_INTEGRATION_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_language_integration_detailcontent';
