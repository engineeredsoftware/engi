import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_SYSTEM_IDENTITY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_language_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_SYSTEM_ROLE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_language_system_role';
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_SYSTEM_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_language_system_instructions';
...
/**
 * Language Agent - System Prompt
 * 
 * System-level configuration for language operations.
 * 
 * @doc-comment-developing-promptdevelopment
 * domain: agent
 * intent: "System prompt for Language agent"
...
export const LANGUAGE_SYSTEM_PROMPT = new Prompt()
  .set('identity', PROMPTPART_SPECIFIC_AGENT_LANGUAGE_SYSTEM_IDENTITY)
  .set('role', PROMPTPART_SPECIFIC_AGENT_LANGUAGE_SYSTEM_ROLE)
  .set('instructions', PROMPTPART_SPECIFIC_AGENT_LANGUAGE_SYSTEM_INSTRUCTIONS)
