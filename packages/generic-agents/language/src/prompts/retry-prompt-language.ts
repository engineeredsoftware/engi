...
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_RETRY_FAILURE_ANALYSIS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_language_retry_failure_analysis';
import { PROMPTPART_SPECIFIC_AGENT_LANGUAGE_RETRY_RECOVERY_STRATEGY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_language_retry_recovery_strategy';
/**\n * @doc-comment-developing-promptdevelopment\n * domain: agent\n * intent: "(fill intent)"\n * current_version: "GA1.50.0"\n * dependencies: { }\n * benchmarks: [\n *   { "name": "technical_accuracy", "test": "Concrete directives and purpose", "score": 0.46 },\n *   { "name": "implementation_ready", "test": "Usable by registry formatter", "score": 0.46 }\n * ]\n */
/**
 * RETRY PROMPT COMPOSITION - LANGUAGE AGENT
 * 
 * Composed retry step prompt for Language agent using atomic prompt parts.
...
export const LANGUAGE_RETRY_PROMPT = new Prompt()
  .set('analysis', PROMPTPART_SPECIFIC_AGENT_LANGUAGE_RETRY_FAILURE_ANALYSIS)
  .set('recovery', PROMPTPART_SPECIFIC_AGENT_LANGUAGE_RETRY_RECOVERY_STRATEGY)
