...
import { PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_PTRRSTEPS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_figmaprocessor_ptrrsteps_list';
import { PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_TOOLS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_figmaprocessor_tools_list';
import { PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_INTEGRATION_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_figmaprocessor_integration_detailcontent';
