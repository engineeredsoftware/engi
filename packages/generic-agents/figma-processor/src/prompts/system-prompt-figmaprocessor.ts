...
import { PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_figmaprocessor_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_figmaprocessor_system_role';
import { PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_figmaprocessor_system_instructions';
 ...
 * domain: agent
 * intent: "System prompt for Figma Processor agent"
 * current_version: "GA1.50.0"
 * versions: ["2.0.0", "1.0.0"]
 * benchmarks: [
 *   { "name": "system_coherence", "test": "Does the system prompt provide coherent instructions? Rate 0-1", "score": 0.93 },
 *   { "name": "design_completeness", "test": "Does it cover all design processing requirements? Rate 0-1", "score": 0.92 },
 *   { "name": "operational_clarity", "test": "Are operational boundaries and capabilities clearly defined? Rate 0-1", "score": 0.91 }
 * ]
 */
export const FIGMA_PROCESSOR_SYSTEM_PROMPT = new Prompt()
  .set('identity', PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_SYSTEM_IDENTITY)
  .set('role', PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_SYSTEM_ROLE)
