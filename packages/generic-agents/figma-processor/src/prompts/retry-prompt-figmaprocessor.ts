...
import { PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_EXECUTIONPATTERN_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_figmaprocessor_executionpattern_detailcontent';
 ...
 * domain: agent
 * intent: "RETRY step prompt for Figma Processor agent"
 * current_version: "GA1.50.0"
 * versions: ["2.0.0", "1.0.0"]
 * benchmarks: [
 *   { "name": "retry_effectiveness", "test": "Does the prompt enable effective design processing retry strategies? Rate 0-1", "score": 0.86 },
 *   { "name": "failure_analysis", "test": "Are design processing failures properly analyzed? Rate 0-1", "score": 0.88 },
 *   { "name": "recovery_strategy", "test": "Is design processing recovery strategy clear? Rate 0-1", "score": 0.87 }
 * ]
 */
export const FIGMA_PROCESSOR_RETRY_PROMPT = new Prompt()
  .set('header', 'RETRY: Recover Design Processing')
  .set('context', PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_SYSTEM_CONTEXT)
  .set('execution_pattern', PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_EXECUTIONPATTERN_DETAILCONTENT)
  .set('recovery_instructions', 'When design processing fails, analyze failure patterns, adjust processing parameters, select alternative extraction methods, and implement enhanced design parsing strategies.')
