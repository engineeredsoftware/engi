...
import { PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_figmaprocessor_capabilities_list';
 ...
 * domain: agent
 * intent: "PLAN step prompt for Figma Processor agent"
 * current_version: "GA1.50.0"
 * versions: ["2.0.0", "1.0.0"]
 * benchmarks: [
 *   { "name": "planning_clarity", "test": "Does the prompt enable clear design processing planning? Rate 0-1", "score": 0.90 },
 *   { "name": "analysis_depth", "test": "Is design analysis approach well-defined? Rate 0-1", "score": 0.91 },
 *   { "name": "processing_scope", "test": "Can design processing scope be effectively determined? Rate 0-1", "score": 0.89 }
 * ]
 */
export const FIGMA_PROCESSOR_PLAN_PROMPT = new Prompt()
  .set('header', 'PLAN: Design Processing Strategy')
  .set('purpose', PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_PURPOSE_CORESTATEMENT)
  .set('capabilities', PROMPTPART_SPECIFIC_AGENT_FIGMAPROCESSOR_CAPABILITIES_LIST)
  .set('instructions', 'Analyze design structure and components, determine processing methodology, establish asset extraction priorities, and define output formats for comprehensive design analysis.')
