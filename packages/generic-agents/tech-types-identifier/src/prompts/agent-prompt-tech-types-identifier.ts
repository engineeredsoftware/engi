import { PROMPTPART_SPECIFIC_AGENT_TECHTYPESIDENTIFIER_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_techtypesidentifier_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_TECHTYPESIDENTIFIER_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_techtypesidentifier_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_TECHTYPESIDENTIFIER_EXECUTIONPATTERN_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_techtypesidentifier_executionpattern_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_TECHTYPESIDENTIFIER_PTRRSTEPS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_techtypesidentifier_ptrrsteps_list';
import { PROMPTPART_SPECIFIC_AGENT_TECHTYPESIDENTIFIER_TOOLS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_techtypesidentifier_tools_list';
import { PROMPTPART_SPECIFIC_AGENT_TECHTYPESIDENTIFIER_INTEGRATION_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_techtypesidentifier_integration_detailcontent';
