...
import { PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_IDENTITY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_tech_types_identifier_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_ROLE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_tech_types_identifier_system_role';
import { PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_tech_types_identifier_system_instructions';
/**
 * Tech Types Identifier Agent - System Prompt
 * 
 * System-level configuration for tech-types-identifier operations.
 * 
...
export const TECH_TYPES_IDENTIFIER_SYSTEM_PROMPT = new Prompt()
  .set('identity', PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_IDENTITY)
  .set('role', PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_ROLE)
  .set('instructions', PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_INSTRUCTIONS)
