...
import { PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_tech_types_identifier_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_tech_types_identifier_system_role';
import { PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_tech_types_identifier_system_instructions';
/**
