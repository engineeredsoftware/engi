...
import { PROMPTPART_SPECIFIC_AGENT_FILEPICK_EXECUTIONPATTERN_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_filepick_executionpattern_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_FILEPICK_PTRRSTEPS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_filepick_ptrrsteps_list';
...
import { PROMPTPART_SPECIFIC_AGENT_FILEPICK_INTEGRATION_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_filepick_integration_detailcontent';
