...
import { PROMPTPART_SPECIFIC_AGENT_FILEPICK_SYSTEM_CONTEXT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_filepick_system_context';
 ...
 * domain: agent
 * intent: "REFINE step prompt for File Pick agent"
 * current_version: "GA1.50.0"
 * versions: ["2.0.0", "1.0.0"]
 * benchmarks: [
 *   { "name": "refinement_quality", "test": "Does the prompt enable effective file selection refinement? Rate 0-1", "score": 0.88 },
 *   { "name": "accuracy_improvement", "test": "Are file selection results improved through refinement? Rate 0-1", "score": 0.90 },
 *   { "name": "completeness_enhancement", "test": "Is file selection completeness enhanced? Rate 0-1", "score": 0.89 }
 * ]
 */
export const FILE_PICK_REFINE_PROMPT = new Prompt()
  .set('header', 'REFINE: Enhance File Selection')
  ...
  .set('instructions', 'Refine file selection results by improving accuracy of pattern matching, enhancing completeness of relevance filtering, and strengthening output structure and file metadata quality.')
