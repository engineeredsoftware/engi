import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_EXECUTIONPATTERN_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_executionpattern_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_PTRRSTEPS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_ptrrsteps_list';
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_TOOLS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_tools_list';
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_INTEGRATION_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_integration_detailcontent';
