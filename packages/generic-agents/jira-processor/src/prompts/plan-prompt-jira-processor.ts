...
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_PLAN_PROJECT_ANALYSIS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_plan_project_analysis';
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_PLAN_WORKFLOW_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_plan_workflow_strategy';
/**
 ...
 * dependencies: {
 *   "PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_PLAN_PROJECT_ANALYSIS": "GA1.45.0",
 *   "PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_PLAN_WORKFLOW_STRATEGY": "GA1.45.0",
