import { PROMPTPART_SPECIFIC_AGENT_JIRA_PROCESSOR_SYSTEM_IDENTITY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_jira_processor_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_JIRA_PROCESSOR_SYSTEM_ROLE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_jira_processor_system_role';
import { PROMPTPART_SPECIFIC_AGENT_JIRA_PROCESSOR_SYSTEM_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_jira_processor_system_instructions';
