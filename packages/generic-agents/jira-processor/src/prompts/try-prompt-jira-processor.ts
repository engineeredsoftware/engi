...
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_TRY_DIRECTIVES_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_try_directives_instructions';
import { PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_TRY_API_STRATEGY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_jiraprocessor_try_api_strategy';
/**
 ...
 * dependencies: {
 *   "PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_TRY_DIRECTIVES_INSTRUCTIONS": "V26.45.0",
 *   "PROMPTPART_SPECIFIC_AGENT_JIRAPROCESSOR_TRY_API_STRATEGY": "V26.45.0",
 ...
 *   "PROMPTPART_GENERIC_AGENT_GENERATION_IF_UNKNOWN_EMPTY": "V26.50.0",
