...
import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_TRY_DIRECTIVES_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_try_directives_instructions';
import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_TRY_PROCESSING_TECHNIQUES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_try_processing_techniques';
