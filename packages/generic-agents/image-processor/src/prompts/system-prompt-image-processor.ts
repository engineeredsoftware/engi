import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_system_role';
import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_system_instructions';
