...
import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_REFINE_QUALITY_CRITERIA } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_refine_quality_criteria';
import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_REFINE_ENHANCEMENT_TECHNIQUES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_refine_enhancement_techniques';
