...
import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_RETRY_FAILURE_ANALYSIS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_retry_failure_analysis';
import { PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_RETRY_RECOVERY_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_imageprocessor_retry_recovery_strategy';
/**\n * @doc-comment-developing-promptdevelopment\n * domain: agent\n * intent: "(fill intent)"\n * current_version: "GA1.50.0"\n * dependencies: { }\n * benchmarks: [\n *   { "name": "technical_accuracy", "test": "Concrete directives and purpose", "score": 0.46 },\n *   { "name": "implementation_ready", "test": "Usable by registry formatter", "score": 0.46 }\n * ]\n */
/**
 * RETRY PROMPT COMPOSITION - IMAGE PROCESSOR AGENT
 * 
 * Composed retry step prompt for Image Processor agent using atomic prompt parts.
 * This defines how the agent handles processing failures and recovers from visual analysis errors.
 */
...
export const IMAGE_PROCESSOR_RETRY_PROMPT = new Prompt()
  .set('analysis', PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_RETRY_FAILURE_ANALYSIS)
  .set('recovery', PROMPTPART_SPECIFIC_AGENT_IMAGEPROCESSOR_RETRY_RECOVERY_STRATEGY)
