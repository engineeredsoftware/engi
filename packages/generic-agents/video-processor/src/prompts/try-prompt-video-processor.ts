...
import { PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_TRY_DIRECTIVES_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_videoprocessor_try_directives_instructions';
import { PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_TRY_PROCESSING_TECHNIQUES } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_videoprocessor_try_processing_techniques';
