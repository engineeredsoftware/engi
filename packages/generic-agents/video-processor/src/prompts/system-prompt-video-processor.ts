...
import { PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_IDENTITY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_video_processor_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_ROLE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_video_processor_system_role';
import { PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_video_processor_system_instructions';
/**
 * Video Processor Agent - System Prompt
 * 
 * System-level configuration for video-processor operations.
 * 
 * @doc-comment-developing-promptdevelopment
 * domain: agent
 * intent: "System prompt for Video Processor agent"
...
export const VIDEO_PROCESSOR_SYSTEM_PROMPT = new Prompt()
  .set('identity', PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_IDENTITY)
  .set('role', PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_ROLE)
  .set('instructions', PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_INSTRUCTIONS)
