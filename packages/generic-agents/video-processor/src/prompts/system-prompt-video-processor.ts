...
import { PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_video_processor_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_video_processor_system_role';
import { PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_video_processor_system_instructions';
/**
