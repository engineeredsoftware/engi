import { PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_PURPOSE_CORESTATEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_videoprocessor_purpose_corestatement';
import { PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_CAPABILITIES_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_videoprocessor_capabilities_list';
import { PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_EXECUTIONPATTERN_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_videoprocessor_executionpattern_detailcontent';
import { PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_PTRRSTEPS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_videoprocessor_ptrrsteps_list';
import { PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_TOOLS_LIST } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_videoprocessor_tools_list';
import { PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_INTEGRATION_DETAILCONTENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_videoprocessor_integration_detailcontent';
