...
export const VIDEO_PROCESSOR_AGENT_PROMPT = new Prompt()
  .set('purpose', PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_PURPOSE_CORESTATEMENT)
  .set('capabilities', PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_CAPABILITIES_LIST)
  .set('execution', PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_EXECUTIONPATTERN_DETAILCONTENT)
  .set('steps', PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_PTRRSTEPS_LIST)
  .set('tools', PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_TOOLS_LIST)
  .set('integration', PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_INTEGRATION_DETAILCONTENT);
