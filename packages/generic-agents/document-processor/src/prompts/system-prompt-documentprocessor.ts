...
import { PROMPTPART_SPECIFIC_AGENT_DOCUMENTPROCESSOR_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_documentprocessor_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_DOCUMENTPROCESSOR_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_documentprocessor_system_role';
import { PROMPTPART_SPECIFIC_AGENT_DOCUMENTPROCESSOR_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_documentprocessor_system_instructions';
 ...
 * domain: agent
 * intent: "System prompt for Document Processor agent"
 * current_version: "GA1.50.0"
 * versions: ["2.0.0", "1.0.0"]
 * benchmarks: [
 *   { "name": "system_coherence", "test": "Does the system prompt provide coherent instructions? Rate 0-1", "score": 0.94 },
 *   { "name": "processing_completeness", "test": "Does it cover all document processing requirements? Rate 0-1", "score": 0.93 },
 *   { "name": "operational_clarity", "test": "Are operational boundaries and capabilities clearly defined? Rate 0-1", "score": 0.92 }
 * ]
 */
export const DOCUMENT_PROCESSOR_SYSTEM_PROMPT = new Prompt()
  .set('identity', PROMPTPART_SPECIFIC_AGENT_DOCUMENTPROCESSOR_SYSTEM_IDENTITY)
  .set('role', PROMPTPART_SPECIFIC_AGENT_DOCUMENTPROCESSOR_SYSTEM_ROLE)
