...
import { PROMPTPART_SPECIFIC_AGENT_MCPSINITIALIZER_RETRY_FAILURE_ANALYSIS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_mcpsinitializer_retry_failure_analysis';
import { PROMPTPART_SPECIFIC_AGENT_MCPSINITIALIZER_RETRY_RECOVERY_STRATEGY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_mcpsinitializer_retry_recovery_strategy';
/**
...
export const MCPS_INITIALIZER_RETRY_PROMPT = new Prompt()
  .set('analysis', PROMPTPART_SPECIFIC_AGENT_MCPSINITIALIZER_RETRY_FAILURE_ANALYSIS)
  .set('recovery', PROMPTPART_SPECIFIC_AGENT_MCPSINITIALIZER_RETRY_RECOVERY_STRATEGY)
