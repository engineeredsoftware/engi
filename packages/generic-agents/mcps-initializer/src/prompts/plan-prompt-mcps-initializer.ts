...
import { PROMPTPART_SPECIFIC_AGENT_MCPSINITIALIZER_PLAN_PROTOCOL_ANALYSIS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_mcpsinitializer_plan_protocol_analysis';
import { PROMPTPART_SPECIFIC_AGENT_MCPSINITIALIZER_PLAN_INITIALIZATION_STRATEGY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_mcpsinitializer_plan_initialization_strategy';
/**
...
export const MCPS_INITIALIZER_PLAN_PROMPT = new Prompt()
  .set('analysis', PROMPTPART_SPECIFIC_AGENT_MCPSINITIALIZER_PLAN_PROTOCOL_ANALYSIS)
  .set('strategy', PROMPTPART_SPECIFIC_AGENT_MCPSINITIALIZER_PLAN_INITIALIZATION_STRATEGY)
