...
import { PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_IDENTITY } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_mcps_initializer_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_ROLE } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_mcps_initializer_system_role';
import { PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_INSTRUCTIONS } from '@bitcode/prompts/raw_promptparts/specific/promptpart_specific_agent_mcps_initializer_system_instructions';
/**
 * Mcps Initializer Agent - System Prompt
 * 
 * System-level configuration for mcps-initializer operations.
 * 
...
export const MCPS_INITIALIZER_SYSTEM_PROMPT = new Prompt()
  .set('identity', PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_IDENTITY)
  .set('role', PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_ROLE)
  .set('instructions', PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_INSTRUCTIONS)
