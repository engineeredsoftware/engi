...
import { PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_IDENTITY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_mcps_initializer_system_identity';
import { PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_ROLE } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_mcps_initializer_system_role';
import { PROMPTPART_SPECIFIC_AGENT_MCPS_INITIALIZER_SYSTEM_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_mcps_initializer_system_instructions';
/**
