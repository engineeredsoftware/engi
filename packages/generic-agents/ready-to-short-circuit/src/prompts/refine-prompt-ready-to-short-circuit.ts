...
import { PROMPTPART_SPECIFIC_AGENT_READYTOSHORTCIRCUIT_REFINE_OPTIMIZATION_CRITERIA } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_readytoshortcircuit_refine_optimization_criteria';
import { PROMPTPART_SPECIFIC_AGENT_READYTOSHORTCIRCUIT_REFINE_DETECTION_ENHANCEMENT } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_readytoshortcircuit_refine_detection_enhancement';
