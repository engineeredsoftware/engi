import { PROMPTPART_SPECIFIC_AGENT_AUDIOPROCESSOR_TRY_DIRECTIVES_INSTRUCTIONS } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_audioprocessor_try_execution_instructions';
import { PROMPTPART_SPECIFIC_AGENT_AUDIOPROCESSOR_TRY_PROCESSING_STRATEGY } from '@engi/prompts/raw_promptparts/specific/promptpart_specific_agent_audioprocessor_try_processing_strategy';
