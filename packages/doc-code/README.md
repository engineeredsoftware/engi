...
2. Injects `instance.__docCodePrompt = PROMPTNAME` after instantiation
3. Makes prompts available at runtime for LLM consumption
...
3. **Code Injection**: Adds `__docCodePrompt` assignment after instantiation
4. **Runtime Access**: Tools can be queried for their documentation

## Current Implementation

- **doc-code-tool**: The only current implementation for Tool classes
