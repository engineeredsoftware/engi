...
export const PROMPTPART_SPECIFIC_TOOL_GENERATEREADSATISFACTIONCRITERIA_DOCCODETOOLNAME: PromptPart =
  "Generate Read Satisfaction Criteria Tool" as PromptPart;
