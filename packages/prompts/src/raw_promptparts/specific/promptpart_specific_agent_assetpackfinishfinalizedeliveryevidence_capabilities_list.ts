 ...
 * domain: auto
 * intent: "Bitcode AssetPack Finish PromptPart for delivery-evidence finalization over validated Need-satisfaction AssetPack written assets: agent assetpackfinishfinalizedeliveryevidence capabilities list"
