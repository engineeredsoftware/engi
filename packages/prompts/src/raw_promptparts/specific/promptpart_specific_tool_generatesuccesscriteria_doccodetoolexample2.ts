...
export const PROMPTPART_SPECIFIC_TOOL_GENERATESUCCESSCRITERIA_DOCCODETOOLEXAMPLE2: PromptPart =
  "Example 2 - Diagnostic written asset: generateNeedSatisfactionCriteria({ writtenAssetType: \"jira-comment\", needRequirements: { evidence: [\"deployment log\"] } }) -> requires factual log summary, no unsupported claims, actionable next step, and correct Jira payload fields." as PromptPart;
