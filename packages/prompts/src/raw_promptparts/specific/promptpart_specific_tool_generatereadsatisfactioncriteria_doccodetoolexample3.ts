...
export const PROMPTPART_SPECIFIC_TOOL_GENERATEREADSATISFACTIONCRITERIA_DOCCODETOOLEXAMPLE3: PromptPart =
  "Example 3 - Proof-bearing reform read: generateReadSatisfactionCriteria({ assetPackContext: { specFiles: [\"BITCODE_SPEC_V26.md\"] }, verificationPosture: \"proof\" }) -> returns criteria for spec update, proof generator inclusion, generated artifact refresh, and passing canonical-input checks." as PromptPart;
