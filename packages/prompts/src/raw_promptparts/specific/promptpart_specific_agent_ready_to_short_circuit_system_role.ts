 ...
 * domain: agent
 * intent: "Agent-specific semantic unit (PROMPTPART_SPECIFIC_AGENT_READY_TO_SHORT_CIRCUIT_SYSTEM_ROLE)"
...
export const PROMPTPART_SPECIFIC_AGENT_READY_TO_SHORT_CIRCUIT_SYSTEM_ROLE: PromptPart = 
