...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATENEEDCOMPREHENSION_DOCCODETOOLEXAMPLE2: PromptPart =
  "Example 2 - Need gap detection: validateNeedComprehension({ needComprehension: { writtenAssetType: \"source-change-set\", definitionOfNeed: \"done\" }, validationCriteria: { completenessThreshold: 0.9 } }) -> flags missing need, satisfaction criteria, proof plan, and delivery-mechanism boundaries." as PromptPart;
