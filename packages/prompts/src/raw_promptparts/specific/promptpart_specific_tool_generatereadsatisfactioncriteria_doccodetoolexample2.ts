...
export const PROMPTPART_SPECIFIC_TOOL_GENERATEREADSATISFACTIONCRITERIA_DOCCODETOOLEXAMPLE2: PromptPart =
  "Example 2 - Diagnostic written asset: generateReadSatisfactionCriteria({ writtenAssetType: \"diagnostic-summary\", readRequirements: { evidence: [\"deployment log\"] } }) -> requires factual log summary, no unsupported claims, actionable next step, and correct Jira payload fields." as PromptPart;
