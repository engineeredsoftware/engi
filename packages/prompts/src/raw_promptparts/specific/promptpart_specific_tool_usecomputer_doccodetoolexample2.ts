 ...
 * domain: tool
 * intent: "Example internal Read-measurement stdin and timeout command"
...
export const PROMPTPART_SPECIFIC_TOOL_USECOMPUTER_DOCCODETOOLEXAMPLE2: PromptPart =
  'Read-measurement evidence example: command = "cat", stdin = "hello", timeoutMs = 3000 → returns stdout "hello\\n", exitCode 0' as PromptPart;
