 ...
 * domain: agent
 * intent: "Phase header for ComprehendRead TRY step"
 * current_version: "V26"
 * versions: []
 * benchmarks: [
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_COMPREHENDREAD_PHASE_TRY_LABEL: PromptPart =
  'TRY: Execute Read Comprehension' as PromptPart;
