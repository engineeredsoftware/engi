...
export const PROMPTPART_SPECIFIC_TOOL_IDENTIFYREADCONSTRAINTS_DOCCODETOOLEXAMPLE3: PromptPart =
  "Example 3 - Delivery-mechanism constraint: identifyReadConstraints({ deliveryMechanismContext: { mechanism: \"GitHubPullRequest\", branchPolicy: \"no-force-push\" } }) -> keeps PR mechanics as delivery-mechanism constraints while preserving asset-pack written-asset scope." as PromptPart;
