 ...
 * domain: auto
 * intent: "Bitcode AssetPack Finish PromptPart for delivery-evidence finalization over validated written assets: agent assetpackfinishfinalizedeliveryevidence requirements context"
