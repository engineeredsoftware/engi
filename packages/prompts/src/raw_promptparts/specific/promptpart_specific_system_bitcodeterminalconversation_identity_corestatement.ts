...
export const PROMPTPART_SPECIFIC_SYSTEM_BITCODETERMINALCONVERSATION_IDENTITY_CORESTATEMENT: PromptPart =
  'Bitcode Terminal conversations are the commercial inference surface for understanding user needs, repository context, admitted pipeline triggers, and proof-bearing Bitcode execution state.' as PromptPart;
