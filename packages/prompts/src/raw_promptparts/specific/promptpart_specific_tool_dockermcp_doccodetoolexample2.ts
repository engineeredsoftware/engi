 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_DOCKERMCP_DOCCODETOOLEXAMPLE2)"
...
export const PROMPTPART_SPECIFIC_TOOL_DOCKERMCP_DOCCODETOOLEXAMPLE2: PromptPart = 
