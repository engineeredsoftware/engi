...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZENEEDSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLOUTPUT: PromptPart =
  "Returns NeedSatisfactionImplementationComplexity with overallComplexity, implementationComplexity, integrationComplexity, persistenceComplexity, proofComplexity, testComplexity, deliveryMechanismComplexity, riskAnalysis, sequencingRecommendations, and verificationPlan." as PromptPart;
