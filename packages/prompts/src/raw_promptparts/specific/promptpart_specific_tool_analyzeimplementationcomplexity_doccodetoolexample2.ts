...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZEIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLEXAMPLE2: PromptPart =
  "Example 2 - Exchange route change: analyzeAssetPackImplementationComplexity({ writtenAssetType: \"pull-request\", affectedPackages: [\"packages/api\", \"uapi\"], shippingWrapper: \"GitHubPullRequest\" }) -> separates route semantics, client stream parsing, persistence, and PR wrapper complexity." as PromptPart;
