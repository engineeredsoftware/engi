 ...
 * domain: auto
 * intent: "Bitcode AssetPack-native PromptPart for read-first asset-pack setup: agent assetpacksetupclonerepository requirements context"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_ASSETPACKSETUPCLONEREPOSITORY_REQUIREMENTS_CONTEXT: PromptPart = 
