 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_TOOL_BEGINTRANSACTION_DOCCODETOOLCAPABILITIES: PromptPart =
  'Tracks staged changes, validates consistency, and prepares atomic apply or rollback' as PromptPart;
