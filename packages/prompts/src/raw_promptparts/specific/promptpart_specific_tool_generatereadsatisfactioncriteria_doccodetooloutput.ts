...
export const PROMPTPART_SPECIFIC_TOOL_GENERATEREADSATISFACTIONCRITERIA_DOCCODETOOLOUTPUT: PromptPart =
  "Returns ReadSatisfactionCriteria with functionalCriteria, proofCriteria, qualityCriteria, persistenceCriteria, interfaceCriteria, operatorExperienceCriteria, validationPlan, blockingCriteria, and acceptanceClarityScore." as PromptPart;
