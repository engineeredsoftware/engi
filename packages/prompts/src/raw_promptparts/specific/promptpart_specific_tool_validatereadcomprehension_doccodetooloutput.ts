...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATEREADCOMPREHENSION_DOCCODETOOLOUTPUT: PromptPart =
  "Returns ReadComprehensionValidation with validationResults, validationDetails, terminologyFindings, ambiguityFindings, writtenAssetCoherence, proofCoverage, recommendations, validationPassed, and validationMetadata." as PromptPart;
