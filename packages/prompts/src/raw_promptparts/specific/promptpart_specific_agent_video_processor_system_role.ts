 ...
 * domain: agent
 * intent: "Agent-specific semantic unit (PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_ROLE)"
...
export const PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_ROLE: PromptPart = 
