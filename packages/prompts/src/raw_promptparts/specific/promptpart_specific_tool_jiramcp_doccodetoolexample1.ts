 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_JIRAMCP_DOCCODETOOLEXAMPLE1)"
...
export const PROMPTPART_SPECIFIC_TOOL_JIRAMCP_DOCCODETOOLEXAMPLE1: PromptPart = 
