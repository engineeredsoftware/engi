...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATENEEDCOMPREHENSION_DOCCODETOOLPURPOSE: PromptPart =
  "Validate that a need-comprehension analysis has correctly understood the Bitcode need, written-asset expectations, asset-pack boundaries, constraints, satisfaction criteria, and delivery-mechanism limits before synthesis proceeds." as PromptPart;
