...
export const PROMPTPART_SPECIFIC_AGENT_COMPREHENDNEED_TRY_DIRECTIVES: PromptPart =
  'Execute need comprehension through: entity and intent extraction, written-asset classification, constraint mapping, acceptance-criteria formulation, delivery-mechanism separation, dependency identification, ambiguity scoring, appropriate tool calls, and structured Need-model generation.' as PromptPart;
