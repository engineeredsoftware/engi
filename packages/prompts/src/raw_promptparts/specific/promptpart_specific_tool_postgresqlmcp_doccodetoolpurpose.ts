 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_POSTGRESQLMCP_DOCCODETOOLPURPOSE)"
...
export const PROMPTPART_SPECIFIC_TOOL_POSTGRESQLMCP_DOCCODETOOLPURPOSE: PromptPart = 
