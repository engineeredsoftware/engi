...
export const PROMPTPART_SPECIFIC_AGENT_DELIVERABLEIMPLEMENTATIONCORRECTPULLREQUEST_TRY_SUBSTEP_STITCH_UNTIL_COMPLETE: PromptPart = 
  'deliverableimplementationcorrectpullrequest try substep stitch until complete: combine partial findings, diffs, validations, and delivery-mechanism details into one coherent asset-pack result that can be reread from execution history.' as PromptPart;