 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLPARAMETERS)"
...
export const PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLPARAMETERS: PromptPart = 
