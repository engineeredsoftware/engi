...
export const PROMPTPART_SPECIFIC_TOOL_EXTRACTREQUIREMENTS_DOCCODETOOLCAPABILITIES: PromptPart =
  "Capabilities: classify functional, non-functional, business, technical, proof, persistence, and interface requirements; link each requirement to evidence; distinguish stable written-asset content from shipping-wrapper ceremony; identify missing acceptance detail and dependency order." as PromptPart;
