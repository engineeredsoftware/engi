 ...
 * domain: agent
 * intent: "RETRY-step output requirement for ApplyFile agent"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_APPLYFILE_RETRY_OUTPUT_REQUIREMENT_DETAILCONTENT: PromptPart =
