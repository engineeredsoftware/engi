 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_TOOL_BEGINTRANSACTION_DOCCODETOOLPURPOSE: PromptPart =
  'Begin and coordinate a batch of related file edits as a single transaction' as PromptPart;
