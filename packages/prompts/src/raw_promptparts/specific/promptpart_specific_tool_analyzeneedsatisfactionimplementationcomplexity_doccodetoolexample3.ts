...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZENEEDSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLEXAMPLE3: PromptPart =
  "Example 3 - Gate-closure reform: analyzeNeedSatisfactionImplementationComplexity({ needComprehension: { primaryIntent: \"close fifth-gate residue\" }, complexityScale: \"gateClosure\", proofRequirements: [\"spec-family\", \"canonical-input\", \"generated-proven\"] }) -> returns sequencing, proof, regression, and acceptance-risk analysis for a broad Bitcode reform pass." as PromptPart;
