...
export const PROMPTPART_SPECIFIC_AGENT_CREATECODECHANGE_SYSTEM_ROLE: PromptPart = 
  'Your role is to synthesize all implementation and validation artifacts into a cohesive pull request delivery mechanism, craft clear descriptions from execution context, establish merge criteria from accumulated state, and prepare validated written assets for production deployment' as PromptPart;
