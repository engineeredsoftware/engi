 ...
 * domain: agent
 * intent: "REFINE-step output requirement for ApplyFile agent"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_APPLYFILE_REFINE_OUTPUT_REQUIREMENT_DETAILCONTENT: PromptPart =
