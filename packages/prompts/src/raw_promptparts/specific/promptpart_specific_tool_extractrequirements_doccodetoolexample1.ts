...
export const PROMPTPART_SPECIFIC_TOOL_EXTRACTREQUIREMENTS_DOCCODETOOLEXAMPLE1: PromptPart =
  "Example 1 - API repair need: extractNeedRequirements({ expressedNeed: \"Make /api/deliverables emit writtenAssets and deliveryMechanism aliases\", requiredViews: [\"functional\", \"proof\", \"interface\"] }) -> returns route behavior requirements, stream-payload expectations, and proof assertions." as PromptPart;
