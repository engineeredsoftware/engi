 ...
 * domain: agent
 * intent: "Compatibility PromptPart for the former deliverables setup comprehend-task purpose core statement; content is canonical comprehend-need semantics."
