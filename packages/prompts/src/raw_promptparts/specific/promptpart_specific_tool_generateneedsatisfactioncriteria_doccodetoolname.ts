...
export const PROMPTPART_SPECIFIC_TOOL_GENERATENEEDSATISFACTIONCRITERIA_DOCCODETOOLNAME: PromptPart =
  "Generate Need Satisfaction Criteria Tool" as PromptPart;
