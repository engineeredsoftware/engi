 ...
 * domain: agent
 * intent: "Bitcode retained deliverable-compatibility PromptPart for written-asset synthesis from asset-pack execution: agent deliverableimplementationreviewpullrequest capabilities list"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_DELIVERABLEIMPLEMENTATIONREVIEWPULLREQUEST_CAPABILITIES_LIST: PromptPart = 
