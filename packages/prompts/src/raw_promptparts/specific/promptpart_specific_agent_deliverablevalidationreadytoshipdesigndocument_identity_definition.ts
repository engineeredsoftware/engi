 ...
 * domain: auto
 * intent: "Agent semantic unit: Deliverablevalidationreadytoshipdesigndocument Identity Definition"
 ...
 * @doc-comment-developing-promptpartdevelopment
 * domain: agent
 * intent: "identity definition for Ready to Ship Design Document agent"
 * current_version: "GA1.50.0"
 * versions: []
 * benchmarks: [
