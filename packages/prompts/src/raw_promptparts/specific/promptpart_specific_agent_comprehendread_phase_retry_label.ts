 ...
 * domain: agent
 * intent: "Phase header for ComprehendRead RETRY step"
 * current_version: "V26"
 * versions: []
 * benchmarks: [
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_COMPREHENDREAD_PHASE_RETRY_LABEL: PromptPart =
  'RETRY: Recover Read Understanding' as PromptPart;
