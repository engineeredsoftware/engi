 ...
 * domain: agent
 * intent: "Agent-specific semantic unit (PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_ROLE)"
...
export const PROMPTPART_SPECIFIC_AGENT_TECH_TYPES_IDENTIFIER_SYSTEM_ROLE: PromptPart = 
