...
export const PROMPTPART_SPECIFIC_TOOL_GENERATEREADSATISFACTIONCRITERIA_DOCCODETOOLPURPOSE: PromptPart =
  "Generate measurable Bitcode read-satisfaction criteria that define when synthesized written assets, asset-pack state, proofs, and delivery mechanisms satisfy the expressed read." as PromptPart;
