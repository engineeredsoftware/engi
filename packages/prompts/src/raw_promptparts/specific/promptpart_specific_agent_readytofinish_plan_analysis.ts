 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_READYTOFINISH_PLAN_ANALYSIS: PromptPart = 
  'Analyze Finish-readiness context to identify: validation status across phases, written-asset integrity, need-satisfaction risk, delivery-mechanism dependencies, operational gaps, rollback limitations, and decision factors' as PromptPart;
