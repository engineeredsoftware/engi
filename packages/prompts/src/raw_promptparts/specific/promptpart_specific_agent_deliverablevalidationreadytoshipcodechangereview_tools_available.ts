 ...
 * domain: auto
 * intent: "Agent semantic unit: Deliverablevalidationreadytoshipcodechangereview Tools Available"
 ...
 * @doc-comment-developing-promptpartdevelopment
 * domain: agent
 * intent: "tools available for Ready to Ship Code Change Review agent"
 * current_version: "GA1.50.0"
 * versions: []
 * benchmarks: [
