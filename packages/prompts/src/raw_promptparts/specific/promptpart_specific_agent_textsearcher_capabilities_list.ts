 ...
 * domain: agent
 * intent: "Bitcode repository-evidence search capabilities for read measurement and AssetPack source-grounding"
 * current_version: "V26"
 * versions: []
 * benchmarks: [
...
- Select evidence patterns from Bitcode read, proof, prompt, tool, schema, and AssetPack terms
- Preserve file path, zero-based line, matched text, and caller intent as source-grounding context
- Rank evidence by relevance to the active Bitcode read without claiming proof completion
- Surface gaps, missing owners, and ambiguous terminology for downstream read-comprehension, proof, or asset-pack agents
