 ...
 * domain: agent
 * intent: "Compatibility PromptPart for the former deliverables setup comprehend-task audio comprehension execution details; content is canonical comprehend-need semantics."
