...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATENEEDCOMPREHENSION_DOCCODETOOLEXAMPLE3: PromptPart =
  "Example 3 - Delivery-mechanism validation: validateNeedComprehension({ needComprehension: { deliveryMechanismBoundaries: [\"JiraComment\"], writtenAssetExpectations: [\"diagnostic summary\"] }, deliveryMechanismContext: { destination: \"Jira\" } }) -> verifies payload fields without letting Jira own the Bitcode written asset." as PromptPart;
