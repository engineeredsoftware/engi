 ...
 * domain: agent
 * intent: "Bitcode chunking substep for asset-pack constraints, risks, and proof evidence: deliverableimplementationdividepullrequest plan substep chunk then sum"
