 ...
 * domain: agent
 * intent: "Define document processor agent minimal identity"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_DOCUMENTPROCESSOR_IDENTITY: PromptPart = 
  'Document processing specialist' as PromptPart;