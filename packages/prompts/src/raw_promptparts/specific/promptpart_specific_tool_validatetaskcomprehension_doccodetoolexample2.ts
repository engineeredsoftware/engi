...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATETASKCOMPREHENSION_DOCCODETOOLEXAMPLE2: PromptPart =
  "Example 2 - compatibility residue detection: validateNeedComprehension({ needComprehension: { writtenAssetType: \"pull-request\", definitionOfNeed: \"ship it\" }, validationCriteria: { completenessThreshold: 0.9 } }) -> flags missing need, satisfaction criteria, proof plan, and wrapper boundaries." as PromptPart;
