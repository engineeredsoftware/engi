 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_CLOUDFLAREMCP_DOCCODETOOLCAPABILITIES)"
...
export const PROMPTPART_SPECIFIC_TOOL_CLOUDFLAREMCP_DOCCODETOOLCAPABILITIES: PromptPart = 
