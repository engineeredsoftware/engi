...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZEREADSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLEXAMPLE1: PromptPart =
  "Example 1 - Prompt reform slice: analyzeReadSatisfactionImplementationComplexity({ affectedPackages: [\"packages/prompts\", \"packages/generic-tools/read-comprehension\"], proofRequirements: [\"prompt-system-totality\"] }) -> returns medium complexity with raw PromptPart carry-through and proof-refresh risks." as PromptPart;
