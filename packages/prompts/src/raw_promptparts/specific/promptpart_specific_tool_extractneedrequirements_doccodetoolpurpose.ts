...
export const PROMPTPART_SPECIFIC_TOOL_EXTRACTNEEDREQUIREMENTS_DOCCODETOOLPURPOSE: PromptPart =
  "Extract explicit and implied requirements from a Bitcode need so the pipeline can synthesize correct written assets, preserve asset-pack boundaries, and choose only necessary delivery mechanisms." as PromptPart;
