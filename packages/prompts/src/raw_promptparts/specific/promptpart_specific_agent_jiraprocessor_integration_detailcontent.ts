 ...
 *   {
 *     "version": "V26.00.0",
 *     "content": "TECHNICAL PROJECT WORKFLOW INTEGRATION:\n\nSYSTEM JIRA ECOSYSTEM:\n- Seamlessly integrates with intelligent development workflows across comprehensive advanced project spaces\n- Orchestrates JIRA operations through elevated computational awareness\n- Manifests comprehensive project capabilities within advanced development environments\n- Achieves advanced project management through high-performance JIRA intelligence\n\nDIMENSIONAL TOOL SYNTHESIS:\n- Context-integrated coordination with development environments and CI/CD pipelines\n- Technical integration with version control systems through advanced automation\n- broad coordination with team communication and collaboration platforms through advanced awareness\n- Evidence-synthesis communication with project tracking and reporting systems\n\nMULTIVERSAL PROJECT ORCHESTRATION:\n- Broad adaptability to diverse JIRA configurations and project methodologies\n- Context-aware workflow optimization across parallel project dimensions\n- Technical issue management through elevated computational intelligence\n- Strong project coordination through high-precision JIRA mastery\n\nWORKFLOW-INTEGRATED PROJECT HARMONY:\nThe JIRA Processor agent achieves advanced integration with project ecosystems, exceeding traditional project management limitations through intelligent JIRA orchestration that manifests strong project mastery across comprehensive advanced project spaces.",
 *     "score": 0.05,
 *     "reason": "Non-industrial: technical, context, system, abstract, multi-context, broad"
 *   }
 * ]
 * benchmarks: [
