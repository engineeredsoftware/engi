 ...
 * domain: agent
 * intent: "Phase header for ComprehendNeed REFINE step"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_COMPREHENDNEED_PHASE_REFINE_LABEL: PromptPart =
  'REFINE: Enhance Need Understanding' as PromptPart;
