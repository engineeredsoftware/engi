...
export const PROMPTPART_SPECIFIC_TOOL_EXTRACTNEEDREQUIREMENTS_DOCCODETOOLOUTPUT: PromptPart =
  "Returns NeedRequirements with functionalRequirements, nonFunctionalRequirements, businessRequirements, technicalRequirements, proofRequirements, interfaceRequirements, extractionMetadata, evidenceLinks, and writtenAssetRequirementMap." as PromptPart;
