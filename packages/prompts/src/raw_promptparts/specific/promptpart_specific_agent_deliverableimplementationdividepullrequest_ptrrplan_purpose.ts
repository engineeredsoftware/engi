...
export const PROMPTPART_SPECIFIC_AGENT_DELIVERABLEIMPLEMENTATIONDIVIDEPULLREQUEST_PTRRPLAN_PURPOSE: PromptPart = 
  'PTRR Plan Step: analyze context and create a strategic approach for determining file changes needed to synthesize validated written assets for a pull request delivery mechanism' as PromptPart;
