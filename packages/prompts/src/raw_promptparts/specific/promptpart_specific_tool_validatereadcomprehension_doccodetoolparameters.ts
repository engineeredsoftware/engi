...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATEREADCOMPREHENSION_DOCCODETOOLPARAMETERS: PromptPart =
  "Parameters: readComprehension: object; validationCriteria?: { completenessThreshold?: number; accuracyThreshold?: number; consistencyThreshold?: number; proofCoverageThreshold?: number }; repositoryContext?: object; deliveryMechanismContext?: object; canonicalTerminologyRequired?: boolean." as PromptPart;
