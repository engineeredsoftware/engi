...
export const PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_PLAN_SUBSTEP_CHUNK_THEN_SUM: PromptPart = 
  'deliverablesetupdangerwall plan substep chunk then sum: chunk large inputs by need, file, proof, and delivery-mechanism concern; summarize each chunk as written-asset constraints, risks, and acceptance evidence for asset-pack synthesis.' as PromptPart;