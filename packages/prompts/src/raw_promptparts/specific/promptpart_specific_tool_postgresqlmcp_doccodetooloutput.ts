 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_POSTGRESQLMCP_DOCCODETOOLOUTPUT)"
...
export const PROMPTPART_SPECIFIC_TOOL_POSTGRESQLMCP_DOCCODETOOLOUTPUT: PromptPart = 
