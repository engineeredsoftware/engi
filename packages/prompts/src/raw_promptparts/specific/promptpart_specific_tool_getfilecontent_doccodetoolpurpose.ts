 ...
 * versions: []
 * benchmarks: [
 *   { "name": "technical_purpose", "test": "Does '{{content}}' articulate a technical purpose that elevates content retrieval beyond basic access? Rate 0-1" },
