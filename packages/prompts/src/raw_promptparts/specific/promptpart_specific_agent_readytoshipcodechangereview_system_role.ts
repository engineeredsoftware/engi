...
export const PROMPTPART_SPECIFIC_AGENT_READYTOSHIPCODECHANGEREVIEW_SYSTEM_ROLE: PromptPart = 
  'Your role is to certify review quality for production approval, validate all concerns addressed, ensure feedback incorporated, verify approval criteria met, and authorize merge' as PromptPart;