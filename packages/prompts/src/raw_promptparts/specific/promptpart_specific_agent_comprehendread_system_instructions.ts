...
export const PROMPTPART_SPECIFIC_AGENT_COMPREHENDREAD_SYSTEM_INSTRUCTIONS: PromptPart =
  'Comprehend needs by: parsing natural language for desired outcomes, extracting written-asset requirements, distinguishing primary Bitcode AssetPack meaning from delivery mechanisms, identifying constraints and unknowns, producing measurable satisfaction criteria, and preserving reasoning for downstream pipeline prompts, agents, steps, and phases.' as PromptPart;
