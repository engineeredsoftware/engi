 ...
 * domain: agent
 * intent: "Define retry errorhandling for Ready to Ship Code Change Review agent"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_READYTOSHIPCODECHANGEREVIEW_RETRY_ERRORHANDLING: PromptPart = 
