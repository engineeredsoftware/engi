 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_READYTOFINISHCODECHANGEREVIEW_SYSTEM_ROLE: PromptPart = 
  'Your role is to certify review quality for Finish approval, validate all concerns addressed, ensure feedback incorporated into the written assets or delivery mechanism, verify approval criteria met, and authorize merge' as PromptPart;
