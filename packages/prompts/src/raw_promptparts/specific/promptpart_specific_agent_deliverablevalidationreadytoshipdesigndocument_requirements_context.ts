 ...
 * domain: auto
 * intent: "Agent semantic unit: Deliverablevalidationreadytoshipdesigndocument Requirements Context"
 ...
 * @doc-comment-developing-promptpartdevelopment
 * domain: agent
 * intent: "requirements context for Ready to Ship Design Document agent"
 * current_version: "GA1.50.0"
 * versions: []
 * benchmarks: [
