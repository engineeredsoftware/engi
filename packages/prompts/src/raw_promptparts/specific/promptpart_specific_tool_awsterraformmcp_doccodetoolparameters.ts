 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_AWSTERRAFORMMCP_DOCCODETOOLPARAMETERS)"
...
export const PROMPTPART_SPECIFIC_TOOL_AWSTERRAFORMMCP_DOCCODETOOLPARAMETERS: PromptPart = 
