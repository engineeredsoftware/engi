...
export const PROMPTPART_SPECIFIC_TOOL_GENERATEREADSATISFACTIONCRITERIA_DOCCODETOOLCAPABILITIES: PromptPart =
  "Capabilities: convert requirements and constraints into acceptance thresholds; separate functional, quality, proof, persistence, interface, and operator-experience criteria; define verification commands and reread evidence; mark which criteria are blocking for Finish closure." as PromptPart;
