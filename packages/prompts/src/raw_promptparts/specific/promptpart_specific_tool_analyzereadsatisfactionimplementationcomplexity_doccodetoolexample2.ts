...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZEREADSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLEXAMPLE2: PromptPart =
  "Example 2 - Exchange route change: analyzeReadSatisfactionImplementationComplexity({ writtenAssetType: \"source-change-set\", affectedPackages: [\"packages/api\", \"uapi\"], deliveryMechanism: \"GitHubPullRequest\" }) -> separates route semantics, client stream parsing, persistence, and PR delivery mechanism complexity." as PromptPart;
