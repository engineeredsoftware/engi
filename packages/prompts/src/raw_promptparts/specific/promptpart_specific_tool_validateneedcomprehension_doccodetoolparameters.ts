...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATENEEDCOMPREHENSION_DOCCODETOOLPARAMETERS: PromptPart =
  "Parameters: needComprehension: object; validationCriteria?: { completenessThreshold?: number; accuracyThreshold?: number; consistencyThreshold?: number; proofCoverageThreshold?: number }; repositoryContext?: object; deliveryMechanismContext?: object; canonicalTerminologyRequired?: boolean." as PromptPart;
