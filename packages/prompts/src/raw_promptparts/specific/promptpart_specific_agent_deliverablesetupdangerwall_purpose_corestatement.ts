 ...
 * domain: auto
 * intent: "Bitcode retained deliverable-compatibility PromptPart for need-first asset-pack setup: agent deliverablesetupdangerwall purpose corestatement"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPDANGERWALL_PURPOSE_CORESTATEMENT: PromptPart = 
