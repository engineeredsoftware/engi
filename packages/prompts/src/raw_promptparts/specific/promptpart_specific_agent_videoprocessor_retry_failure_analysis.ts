 ...
 * domain: agent
 * intent: "Agent-specific semantic unit (PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_RETRY_FAILURE_ANALYSIS)"
...
export const PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_RETRY_FAILURE_ANALYSIS: PromptPart = 
