 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_FIREBASEMCP_DOCCODETOOLPARAMETERS)"
...
export const PROMPTPART_SPECIFIC_TOOL_FIREBASEMCP_DOCCODETOOLPARAMETERS: PromptPart = 
