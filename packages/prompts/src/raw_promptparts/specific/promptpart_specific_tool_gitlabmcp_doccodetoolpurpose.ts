 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLPURPOSE)"
...
export const PROMPTPART_SPECIFIC_TOOL_GITLABMCP_DOCCODETOOLPURPOSE: PromptPart = 
