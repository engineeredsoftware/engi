...
- Downstream Bitcode owners: consume evidence for read comprehension, proof generation, AssetPack synthesis, file mutation, or delivery without delegating their authority to this agent` as PromptPart;
