...
export const PROMPTPART_SPECIFIC_AGENT_COMPREHENDNEED_PLAN_ANALYSIS: PromptPart =
  'Analyze the expressed need to identify: user outcome, implicit goals, written-asset type, repository or interface constraints, delivery-mechanism expectations, acceptance criteria, evidence requirements, and unknowns that could block need satisfaction before risk admission.' as PromptPart;
