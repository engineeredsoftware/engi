...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATEREADCOMPREHENSION_DOCCODETOOLPURPOSE: PromptPart =
  "Validate that a read-comprehension analysis has correctly understood the Bitcode read, written-asset expectations, asset-pack boundaries, constraints, satisfaction criteria, and delivery-mechanism limits before synthesis proceeds." as PromptPart;
