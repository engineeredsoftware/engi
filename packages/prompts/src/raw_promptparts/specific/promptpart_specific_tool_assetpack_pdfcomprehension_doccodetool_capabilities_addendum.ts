 ...
 * domain: tool
 * intent: "Bitcode AssetPack tool PromptPart for need-first asset-pack setup and written-asset evidence: tool asset-pack pdfcomprehension doccodetool capabilities addendum"
