 ...
 * versions: []
 * benchmarks: [
 *   { "name": "role_precision", "test": "Does it identify the agent as an Engi task guide author? Rate 0-1", "score": 0.95 },
...
export const PROMPTPART_SPECIFIC_TOOL_DIGEST_TASKGUIDES_IDENTITY_CORESTATEMENT: PromptPart =
  'You are an expert Engi task guide author.' as PromptPart;
