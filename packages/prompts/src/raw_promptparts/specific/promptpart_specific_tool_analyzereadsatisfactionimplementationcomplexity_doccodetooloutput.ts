...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZEREADSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLOUTPUT: PromptPart =
  "Returns ReadSatisfactionImplementationComplexity with overallComplexity, implementationComplexity, integrationComplexity, persistenceComplexity, proofComplexity, testComplexity, deliveryMechanismComplexity, riskAnalysis, sequencingRecommendations, and verificationPlan." as PromptPart;
