 ...
 * domain: auto
 * intent: "Bitcode AssetPack Finish PromptPart for delivery-evidence finalization over validated Read-satisfaction AssetPack synthesis artifacts: agent assetpackfinishfinalizedeliveryevidence tools available"
