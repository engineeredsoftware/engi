 ...
 * domain: auto
 * intent: "Agent semantic unit: Deliverablediscoveryunderstandrequirements Requirements Context"
 ...
 * @doc-comment-developing-promptpartdevelopment
 * domain: agent
 * intent: "requirements context for Understand Requirements agent"
 * current_version: "GA1.50.0"
 * versions: []
 * benchmarks: [
