...
export const PROMPTPART_SPECIFIC_TOOL_EXTRACTREADREQUIREMENTS_DOCCODETOOLCAPABILITIES: PromptPart =
  "Capabilities: classify functional, non-functional, business, technical, proof, persistence, and interface requirements; link each requirement to evidence; distinguish stable written-asset content from delivery-mechanism ceremony; identify missing acceptance detail and dependency order." as PromptPart;
