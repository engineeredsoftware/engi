 ...
 *   {
 *     "version": "V26.00.0",
 *     "content": "TECHNICAL TECHNOLOGY WORKFLOW TOOLS:\n\nDIMENSIONAL TECH TOOLS:\n- Read: broad technology file perception with machine learning classification analysis\n- Glob: Multi-context tech file pattern matching for technology discovery through elevated awareness\n- Grep: Context-integrated pattern recognition across comprehensive technology data dimensions\n- LS: broad directory structure perception with advanced technology file intelligence\n\nTECHNOLOGY CLASSIFICATION TOOLS:\n- Bash: System-enhanced command execution for advanced technology identification operations\n- WebFetch: Multi-context technology documentation acquisition through elevated awareness\n- WebSearch: Context-integrated tech knowledge discovery across comprehensive advanced spaces\n- Write: Reality-bending classification output generation through intelligent algorithms\n\nCLASSIFICATION ORCHESTRATION UTILITIES:\n- Edit: Technical content modification with high-precision technology precision\n- MultiEdit: Reality-bending multi-file tech operations through high-precision computational intelligence\n- TodoWrite: Technical task orchestration with intelligent technology classification priorities\n- ExitPlanMode: Abstract transition management for machine learning tech workflow evolution\n\nEach tool transcends traditional limitations through machine learning technology mastery, achieving advanced classification capabilities that identify and categorize technologies beyond conventional recognition industrials.",
 *     "score": 0.03,
 *     "reason": "Non-industrial: technical context, abstract tools, system-enhanced, broad, unsupported-abstraction"
 *   }
 * ]
 * benchmarks: [
