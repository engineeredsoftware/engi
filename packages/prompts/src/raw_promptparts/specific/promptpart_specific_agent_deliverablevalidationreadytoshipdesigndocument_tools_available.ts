 ...
 * domain: auto
 * intent: "Agent semantic unit: Deliverablevalidationreadytoshipdesigndocument Tools Available"
 ...
 * @doc-comment-developing-promptpartdevelopment
 * domain: agent
 * intent: "tools available for Ready to Ship Design Document agent"
 * current_version: "GA1.50.0"
 * versions: []
 * benchmarks: [
