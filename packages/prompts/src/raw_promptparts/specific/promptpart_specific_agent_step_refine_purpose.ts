 ...
 * domain: agent
 * intent: "Define PTRR Refine step generic purpose"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_STEP_REFINE_PURPOSE: PromptPart = 
  'Enhance quality and accuracy' as PromptPart;