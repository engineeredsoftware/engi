 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLCAPABILITIES)"
...
export const PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLCAPABILITIES: PromptPart = 
