 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_TOOL_BEGINTRANSACTION_USAGE_BESTFOR_DETAILCONTENT: PromptPart =
  'Use in production workflows requiring safe, auditable, and reversible changes' as PromptPart;
