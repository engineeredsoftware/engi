...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZEREADSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLPARAMETERS: PromptPart =
  "Parameters: readComprehension: object; repositoryContext?: object; assetPackContext?: object; writtenAssetType?: string; affectedPackages?: string[]; proofRequirements?: string[]; deliveryMechanism?: string; complexityScale?: \"lowMediumHigh\" | \"enterprise\" | \"gateClosure\"." as PromptPart;
