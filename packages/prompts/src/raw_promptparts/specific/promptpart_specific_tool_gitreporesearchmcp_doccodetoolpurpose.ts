 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLPURPOSE)"
...
export const PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLPURPOSE: PromptPart = 
