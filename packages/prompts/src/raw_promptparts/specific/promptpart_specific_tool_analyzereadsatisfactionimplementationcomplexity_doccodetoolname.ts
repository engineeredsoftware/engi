...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZEREADSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLNAME: PromptPart =
  "Analyze Read Satisfaction Implementation Complexity Tool" as PromptPart;
