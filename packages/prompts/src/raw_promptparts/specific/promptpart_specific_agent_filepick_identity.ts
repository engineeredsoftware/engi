 ...
 * domain: agent
 * intent: "Define file pick agent minimal identity"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_FILEPICK_IDENTITY: PromptPart = 
  'File discovery specialist' as PromptPart;