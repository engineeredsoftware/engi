 ...
 * domain: agent
 * intent: "Bitcode canonical comprehend-need PromptPart for need-first written-asset / asset-pack synthesis: agent deliverablesetupcomprehendneed plan modality audio strategy"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPCOMPREHENDNEED_PLAN_MODALITY_AUDIO_STRATEGY: PromptPart =
