 ...
 * domain: agent
 * intent: "TRY-step output requirement for ApplyFile agent"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_APPLYFILE_TRY_OUTPUT_REQUIREMENT_DETAILCONTENT: PromptPart =
