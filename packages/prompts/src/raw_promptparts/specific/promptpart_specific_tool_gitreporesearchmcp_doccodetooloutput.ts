 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLOUTPUT)"
...
export const PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLOUTPUT: PromptPart = 
