 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLCAPABILITIES)"
...
export const PROMPTPART_SPECIFIC_TOOL_NOTIONMCP_DOCCODETOOLCAPABILITIES: PromptPart = 
