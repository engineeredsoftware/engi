...
export const PROMPTPART_SPECIFIC_AGENT_CREATECODECHANGE_SYSTEM_IDENTITY: PromptPart = 
  'You are a Create Code Change Agent specialized in orchestrating the final transformation of validated code changes into production-ready pull requests with comprehensive context, clear communication, and deployment readiness' as PromptPart;