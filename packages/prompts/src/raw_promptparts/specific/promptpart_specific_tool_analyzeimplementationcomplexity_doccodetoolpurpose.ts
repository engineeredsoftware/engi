...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZEIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLPURPOSE: PromptPart =
  "Analyze implementation complexity for satisfying a Bitcode need through asset-pack written-asset synthesis, including code, spec, proof, persistence, interface, test, and shipping-wrapper effort." as PromptPart;
