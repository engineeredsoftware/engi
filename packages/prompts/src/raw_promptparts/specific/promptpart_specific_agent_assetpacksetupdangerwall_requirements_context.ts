 ...
 * domain: auto
 * intent: "Bitcode AssetPack-native PromptPart for read-first asset-pack setup: agent assetpacksetupdangerwall requirements context"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_ASSETPACKSETUPDANGERWALL_REQUIREMENTS_CONTEXT: PromptPart = 
