 ...
 * domain: auto
 * intent: "Bitcode AssetPack Finish delivery PromptPart for providing validated Read-satisfaction AssetPack synthesis artifacts through a delivery mechanism: agent assetpackfinishcreatepullrequestdelivery tools available"
