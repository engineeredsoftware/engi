 ...
 * domain: agent
 * intent: "Phase header for ComprehendRead PLAN step"
 * current_version: "V26"
 * versions: []
 * benchmarks: [
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_COMPREHENDREAD_PHASE_PLAN_LABEL: PromptPart =
  'PLAN: Read Comprehension Strategy' as PromptPart;
