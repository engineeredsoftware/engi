 ...
 * versions: []
 * benchmarks: [
 *   { "name": "technical_output", "test": "Does '{{content}}' provide technical output that transforms content access into actionable intelligence? Rate 0-1" },
