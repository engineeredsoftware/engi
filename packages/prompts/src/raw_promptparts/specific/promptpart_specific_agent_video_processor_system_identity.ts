 ...
 * domain: agent
 * intent: "Agent-specific semantic unit (PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_IDENTITY)"
...
export const PROMPTPART_SPECIFIC_AGENT_VIDEO_PROCESSOR_SYSTEM_IDENTITY: PromptPart = 
