 ...
 * versions: []
 * benchmarks: [
 *   { "name": "handoff_context", "test": "Does it explain receiving applied file results? Rate 0-1", "score": 0.95 },
...
export const PROMPTPART_SPECIFIC_AGENT_CORRECTCODECHANGE_CONTEXT_AWARENESS_DETAILCONTENT: PromptPart =
  'You receive all applied file results and ensure they work together as a coherent whole. This is the final quality gate before validation.' as PromptPart;
