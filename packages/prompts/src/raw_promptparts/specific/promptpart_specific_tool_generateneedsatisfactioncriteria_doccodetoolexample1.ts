...
export const PROMPTPART_SPECIFIC_TOOL_GENERATENEEDSATISFACTIONCRITERIA_DOCCODETOOLEXAMPLE1: PromptPart =
  "Example 1 - Code written asset: generateNeedSatisfactionCriteria({ writtenAssetType: \"source-change-set\", verificationPosture: \"mixed\" }) -> requires source changes, focused tests, typecheck, rereadable summary, and PR delivery mechanism coherence." as PromptPart;
