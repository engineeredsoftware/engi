...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZENEEDSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLEXAMPLE1: PromptPart =
  "Example 1 - Prompt reform slice: analyzeNeedSatisfactionImplementationComplexity({ affectedPackages: [\"packages/prompts\", \"packages/generic-tools/need-comprehension\"], proofRequirements: [\"prompt-system-totality\"] }) -> returns medium complexity with raw PromptPart carry-through and proof-refresh risks." as PromptPart;
