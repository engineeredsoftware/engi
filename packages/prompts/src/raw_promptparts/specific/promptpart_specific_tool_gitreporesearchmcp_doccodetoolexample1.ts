 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLEXAMPLE1)"
...
export const PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLEXAMPLE1: PromptPart = 
