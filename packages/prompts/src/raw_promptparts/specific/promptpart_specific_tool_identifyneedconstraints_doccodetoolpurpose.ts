...
export const PROMPTPART_SPECIFIC_TOOL_IDENTIFYNEEDCONSTRAINTS_DOCCODETOOLPURPOSE: PromptPart =
  "Identify constraints that govern how a Bitcode need can be satisfied, including repository, runtime, proof, persistence, wallet/readiness, interface, security, and delivery-mechanism limits." as PromptPart;
