...
export const PROMPTPART_SPECIFIC_TOOL_EXTRACTREADREQUIREMENTS_DOCCODETOOLPARAMETERS: PromptPart =
  "Parameters: expressedRead: string; readSemantics?: ReadSemantics; repositoryContext?: object; attachmentContext?: Array<{ name: string; kind: string; summary: string }>; requiredViews?: Array<\"functional\" | \"nonFunctional\" | \"business\" | \"technical\" | \"proof\" | \"interface\" | \"persistence\">." as PromptPart;
