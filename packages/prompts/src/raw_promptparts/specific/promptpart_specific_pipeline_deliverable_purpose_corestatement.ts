 ...
 * domain: pipeline
 * intent: "Bitcode retained deliverable-compatibility pipeline PromptPart for need-first asset-pack execution and delivery-wrapper separation: pipeline deliverable purpose corestatement"
