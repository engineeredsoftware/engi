...
export const PROMPTPART_SPECIFIC_TOOL_EXTRACTNEEDREQUIREMENTS_DOCCODETOOLEXAMPLE1: PromptPart =
  "Example 1 - API repair need: extractNeedRequirements({ expressedNeed: \"Make /api/asset-packs expose writtenAssets and deliveryMechanism fields\", requiredViews: [\"functional\", \"proof\", \"interface\"] }) -> returns route behavior requirements, stream-payload expectations, and proof assertions." as PromptPart;
