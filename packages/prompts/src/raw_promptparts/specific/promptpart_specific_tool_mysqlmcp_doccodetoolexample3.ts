 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLEXAMPLE3)"
...
export const PROMPTPART_SPECIFIC_TOOL_MYSQLMCP_DOCCODETOOLEXAMPLE3: PromptPart = 
