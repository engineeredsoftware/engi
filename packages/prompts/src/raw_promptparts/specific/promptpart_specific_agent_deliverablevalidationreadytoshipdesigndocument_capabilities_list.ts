 ...
 * domain: auto
 * intent: "Agent semantic unit: Deliverablevalidationreadytoshipdesigndocument Capabilities List"
 ...
 * @doc-comment-developing-promptpartdevelopment
 * domain: agent
 * intent: "capabilities list for Ready to Ship Design Document agent"
 * current_version: "0.50.0"
 * versions: []
 * benchmarks: [
