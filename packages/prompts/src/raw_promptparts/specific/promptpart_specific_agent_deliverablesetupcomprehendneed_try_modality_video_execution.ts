 ...
 * domain: agent
 * intent: "Canonical deliverables setup comprehend-need video comprehension execution details"
 ...
 * ]
 */
export const PROMPTPART_SPECIFIC_AGENT_DELIVERABLESETUPCOMPREHENDNEED_TRY_MODALITY_VIDEO_EXECUTION: PromptPart =
