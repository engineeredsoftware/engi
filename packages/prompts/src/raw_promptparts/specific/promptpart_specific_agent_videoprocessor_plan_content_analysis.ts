 ...
 * domain: agent
 * intent: "Agent-specific semantic unit (PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_PLAN_CONTENT_ANALYSIS)"
...
export const PROMPTPART_SPECIFIC_AGENT_VIDEOPROCESSOR_PLAN_CONTENT_ANALYSIS: PromptPart = 
