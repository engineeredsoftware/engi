...
1. Plan: derive bounded evidence patterns from the active read, source owner, proof surface, or AssetPack question
...
5. Handoff: provide evidence to read-comprehension, proof, asset-pack, mutation, or delivery owners without assuming their authority` as PromptPart;
