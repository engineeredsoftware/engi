 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLEXAMPLE3)"
...
export const PROMPTPART_SPECIFIC_TOOL_GITREPORESEARCHMCP_DOCCODETOOLEXAMPLE3: PromptPart = 
