 ...
 * domain: auto
 * intent: "Bitcode retained deliverable-compatibility PromptPart for need satisfaction, written-asset validation, and proof evidence: agent deliverablevalidationreadytoshipdesigndocumentreview ptrrtry purpose"
