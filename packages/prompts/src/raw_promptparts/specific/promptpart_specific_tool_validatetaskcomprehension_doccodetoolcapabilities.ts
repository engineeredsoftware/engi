...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATETASKCOMPREHENSION_DOCCODETOOLCAPABILITIES: PromptPart =
  "Capabilities: score completeness, accuracy, consistency, proof coverage, scope containment, ambiguity handling, and written-asset coherence; detect gaps between old compatibility labels and canonical Bitcode meaning; recommend clarification or safe next steps." as PromptPart;
