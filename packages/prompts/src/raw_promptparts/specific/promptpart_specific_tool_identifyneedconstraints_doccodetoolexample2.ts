...
export const PROMPTPART_SPECIFIC_TOOL_IDENTIFYNEEDCONSTRAINTS_DOCCODETOOLEXAMPLE2: PromptPart =
  "Example 2 - Proof constraint: identifyNeedConstraints({ proofContext: { requiredArtifacts: [\".bitcode/prompt-system-totality-proof.json\"] }, severityModel: \"audit\" }) -> marks generated proof refresh and spec-family checks as required validation constraints." as PromptPart;
