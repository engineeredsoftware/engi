 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_JIRAMCP_DOCCODETOOLPURPOSE)"
...
export const PROMPTPART_SPECIFIC_TOOL_JIRAMCP_DOCCODETOOLPURPOSE: PromptPart = 
