...
export const PROMPTPART_SPECIFIC_TOOL_ANALYZENEEDSATISFACTIONIMPLEMENTATIONCOMPLEXITY_DOCCODETOOLNAME: PromptPart =
  "Analyze Need Satisfaction Implementation Complexity Tool" as PromptPart;
