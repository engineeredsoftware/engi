 ...
 * domain: tool
 * intent: "Tool-specific semantic unit (PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLEXAMPLE1)"
...
export const PROMPTPART_SPECIFIC_TOOL_CIRCLECIMCP_DOCCODETOOLEXAMPLE1: PromptPart = 
