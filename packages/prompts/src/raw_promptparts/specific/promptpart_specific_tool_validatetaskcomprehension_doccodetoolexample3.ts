...
export const PROMPTPART_SPECIFIC_TOOL_VALIDATETASKCOMPREHENSION_DOCCODETOOLEXAMPLE3: PromptPart =
  "Example 3 - Shipping-wrapper validation: validateNeedComprehension({ needComprehension: { shippingWrapperBoundaries: [\"JiraComment\"], writtenAssetExpectations: [\"diagnostic summary\"] }, shippingWrapperContext: { destination: \"Jira\" } }) -> verifies payload fields without letting Jira own the Bitcode written asset." as PromptPart;
