...
export const PROMPTPART_SPECIFIC_AGENT_CONVERSATIONAGENT_PTRRRETRY_PURPOSE: PromptPart =
  'Finalize the response, recover incomplete reasoning, and emit safe admitted pipeline-trigger guidance when the conversation need requires action.' as PromptPart;
