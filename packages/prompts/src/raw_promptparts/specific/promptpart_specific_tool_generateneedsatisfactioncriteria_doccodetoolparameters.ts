...
export const PROMPTPART_SPECIFIC_TOOL_GENERATENEEDSATISFACTIONCRITERIA_DOCCODETOOLPARAMETERS: PromptPart =
  "Parameters: needRequirements: object; needConstraints?: object; writtenAssetType?: string; assetPackContext?: object; qualityStandards?: object; verificationPosture?: \"unit\" | \"integration\" | \"e2e\" | \"proof\" | \"mixed\"." as PromptPart;
