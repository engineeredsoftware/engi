 ...
 * domain: tool
 * intent: "Bitcode AssetPack tool PromptPart for need-first asset-pack setup and written-asset evidence: tool repositorysetup asset-pack metadata phase setup"
