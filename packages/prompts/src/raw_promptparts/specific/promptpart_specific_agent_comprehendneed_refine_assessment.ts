...
export const PROMPTPART_SPECIFIC_AGENT_COMPREHENDNEED_REFINE_ASSESSMENT: PromptPart =
  'Assess need-comprehension quality by evaluating: outcome coverage, written-asset specificity, delivery-mechanism separation, ambiguity closure, acceptance-criteria measurability, constraint feasibility, and confidence that the synthesized AssetPack can satisfy the need before risk admission.' as PromptPart;
