 ...
 * ]
 */
export const PROMPTPART_GENERIC_PTRR_TRY_SUBSTEP_STRUCTURED_OUTPUT: PromptPart = 
  'PTRR Try SubStep structured output: format results into schema-compliant structured output' as PromptPart;