...
2. Copy selector keys verbatim when choosing data (repository, source, read, read-definition, config, attachments, evidence_documents, pipeline input, instructions). Never invent new namespaces.
