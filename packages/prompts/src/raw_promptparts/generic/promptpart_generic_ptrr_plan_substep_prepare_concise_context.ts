...
2. Copy selector keys verbatim when choosing data (repository, task, source, DoD, config, attachments, ai_documents, pipeline input, instructions). Never invent new namespaces.
